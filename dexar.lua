-- decompiled by Arceus X (took 157.406458ms)
function CreateGui()
...
local v_u_164 = CreateGui()
v_u_164.Parent = game.Players.LocalPlayer.PlayerGui
spawn(function()
	local v165 = v_u_164
	local v166 = v165:WaitForChild("IntroFrame")
	local v_u_167 = v165:WaitForChild("SideMenu")
	local v_u_168 = v165:WaitForChild("Toggle")
	local v_u_169 = v_u_167:WaitForChild("Toggle")
	local v_u_170 = v_u_167:WaitForChild("OpenScriptEditor")
	local v_u_171 = v165:WaitForChild("ScriptEditor")
	local v_u_172 = v_u_167:WaitForChild("SlideOut"):WaitForChild("SlideFrame")
	local v173 = v_u_167:WaitForChild("Slant")
	v_u_172:WaitForChild("Explorer")
	v_u_172:WaitForChild("Settings")
	local v_u_174 = Instance.new("SelectionBox")
	v_u_174.Parent = v165
	local v175 = v165:WaitForChild("ExplorerPanel")
	local v176 = v165:WaitForChild("PropertiesFrame")
	local v177 = v165:WaitForChild("SaveMapWindow")
	local v178 = v165:WaitForChild("RemoteDebugWindow")
	local v179 = v165:WaitForChild("SettingsPanel")
	local v180 = v179:WaitForChild("GetSetting")
	local v_u_181 = v179:WaitForChild("SettingTemplate")
	local v_u_182 = v179:WaitForChild("SettingList")
	local v_u_183 = v177:WaitForChild("CopyList")
	local v_u_184 = v177:WaitForChild("MapSettings")
	local v_u_185 = v177:WaitForChild("FileName")
	local v_u_186 = v177:WaitForChild("Save")
	local v_u_187 = v177:WaitForChild("Entry")
	local v_u_188 = {
		["CopyWhat"] = {
			["Workspace"] = true,
			["Lighting"] = true,
	...
	local v189 = v175:WaitForChild("TotallyNotSelectionChanged")
	v175:WaitForChild("TotallyNotGetSelection")
	v175:WaitForChild("TotallyNotSetSelection")
	local v_u_190 = game:GetService("Players").LocalPlayer:GetMouse()
	local v_u_191 = "Nothing c:"
	local v_u_192 =
	...
	function switchWindows(p193, p194)
		if v_u_191 ~= p193 or p194 then
			for v195, v196 in pairs(v_u_192) do
				local v197 = 0
				if v195 ~= p193 then
					for _, v198 in pairs(v196) do
						v198:TweenPosition(UDim2.new(1, 30, v197 * 0.5, v197 * 36), "Out", "Quad", 0.5, true)
						v197 = v197 + 1
					end
				end
			end
			local v199 = 0
			if v_u_192[p193] then
				for _, v200 in pairs(v_u_192[p193]) do
					v200:TweenPosition(UDim2.new(1, -300, v199 * 0.5, v199 * 36), "Out", "Quad", 0.5, true)
					v199 = v199 + 1
				end
			end
			if p193 ~= "Nothing c:" then
				v_u_191 = p193
				for _, v201 in pairs(v_u_172:GetChildren()) do
					v201.BackgroundTransparency = 1
					v201.Icon.ImageColor3 = Color3.new(0.27450980392156865, 0.27450980392156865, 0.27450980392156865)
				end
				if v_u_172:FindFirstChild(p193) then
					v_u_172[p193].BackgroundTransparency = 0.5
					v_u_172[p193].Icon.ImageColor3 = Color3.new(0, 0, 0)
				end
			end
		end
	end
	function toggleDex(p202)
		if p202 then
			v_u_167:TweenPosition(UDim2.new(1, -330, 0, 0), "Out", "Quad", 0.5, true)
			v_u_168:TweenPosition(UDim2.new(1, 0, 0, 0), "Out", "Quad", 0.5, true)
			switchWindows(v_u_191, true)
		else
			v_u_167:TweenPosition(UDim2.new(1, 0, 0, 0), "Out", "Quad", 0.5, true)
			v_u_168:TweenPosition(UDim2.new(1, -30, 0, 0), "Out", "Quad", 0.5, true)
	...
	function ReturnSetting(p204)
		if p204 == "ClearProps" then
			return v_u_203.ClearProps
		end
		if p204 == "SelectUngrouped" then
			return v_u_203.SelectUngrouped
		end
	end
	v_u_168.MouseButton1Up:connect(function()
		toggleDex(true)
	end)
	v_u_170.MouseButton1Up:connect(function()
		if v_u_170.Active then
			v_u_171.Visible = true
		end
	end)
	v_u_169.MouseButton1Up:connect(function()
		if v_u_169.Active then
			toggleDex(false)
		end
	end)
	for _, v_u_205 in pairs(v_u_172:GetChildren()) do
		v_u_205.MouseButton1Click:connect(function()
			switchWindows(v_u_205.Name)
		end)
		v_u_205.MouseEnter:connect(function()
			v_u_205.BackgroundTransparency = 0.5
		end)
		v_u_205.MouseLeave:connect(function()
			if v_u_191 ~= v_u_205.Name then
				v_u_205.BackgroundTransparency = 1
			end
		end)
	end
	function createSetting(p206, p_u_207, p208)
		local v_u_209 = v_u_181:Clone()
		v_u_209.Position = UDim2.new(0, 0, 0, #v_u_182:GetChildren() * 60)
		v_u_209.SName.Text = p206
		local function v_u_211(p210)
			if p210 then
				v_u_209.Change.Bar:TweenPosition(
					UDim2.new(0, 32, 0, -2),
				...
				v_u_209.Change.OnBar:TweenSize(
					UDim2.new(0, 34, 0, 15),
					Enum.EasingDirection.Out,
					Enum.EasingStyle.Quart,
					0.25,
				...
				v_u_209.Status.Text = "On"
				v_u_203[p_u_207] = true
			else
				v_u_209.Change.Bar:TweenPosition(
					UDim2.new(0, -2, 0, -2),
					Enum.EasingDirection.Out,
				...
				v_u_209.Status.Text = "Off"
				v_u_203[p_u_207] = false
			end
		end
		v_u_209.Change.MouseButton1Click:connect(function()
			v_u_211(not v_u_203[p_u_207])
		end)
		v_u_209.Visible = true
		v_u_209.Parent = v_u_182
		if p208 then
			v_u_211(true)
		end
	end
	...
	local function v_u_213()
		local v212 = GetSelection:Invoke()
		if v212 and 0 < #v212 then
			return v212[1]
		else
			return nil
		end
	end
	v_u_190.Button1Down:connect(function()
		local v214 = v_u_191 == "Explorer" and v_u_203.ClickSelect and v_u_190.Target
		if v214 then
			SetSelection:Invoke({ v214 })
		end
	end)
	v189.Event:connect(function()
		if v_u_203.SelBox then
			local _, v215 = pcall(function()
				v_u_174.Adornee = v_u_213()
			end)
			if v215 then
				v_u_174.Adornee = nil
			end
	...
	v180.OnInvoke = ReturnSetting
	function createMapSetting(p_u_216, p_u_217, p218)
		local function v_u_220(p219)
			if p219 then
				p_u_216.Change.Bar:TweenPosition(
					UDim2.new(0, 32, 0, -2),
					Enum.EasingDirection.Out,
					Enum.EasingStyle.Quart,
					0.25,
				...
				p_u_216.Change.OnBar:TweenSize(
					UDim2.new(0, 34, 0, 15),
					Enum.EasingDirection.Out,
					Enum.EasingStyle.Quart,
					0.25,
				...
				p_u_216.Status.Text = "On"
				v_u_188[p_u_217] = true
			else
				p_u_216.Change.Bar:TweenPosition(
					UDim2.new(0, -2, 0, -2),
					Enum.EasingDirection.Out,
				...
				p_u_216.Status.Text = "Off"
				v_u_188[p_u_217] = false
			end
		end
		p_u_216.Change.MouseButton1Click:connect(function()
			v_u_220(not v_u_188[p_u_217])
		end)
		p_u_216.Visible = true
		p_u_216.Parent = v_u_184
		if p218 then
			v_u_220(true)
		end
	end
	function createCopyWhatSetting(p_u_221)
		if v_u_188.CopyWhat[p_u_221] then
			local v_u_222 = v_u_187:Clone()
			v_u_222.Position = UDim2.new(0, 0, 0, #v_u_183:GetChildren() * 22 + 5)
			v_u_222.Info.Text = p_u_221
			local function v_u_224(p223)
				if p223 then
					v_u_222.Change.enabled.Visible = true
					v_u_188.CopyWhat[p_u_221] = true
				else
					v_u_222.Change.enabled.Visible = false
					v_u_188.CopyWhat[p_u_221] = false
				end
			end
			v_u_222.Change.MouseButton1Click:connect(function()
				v_u_224(not v_u_188.CopyWhat[p_u_221])
			end)
			v_u_222.Visible = true
			v_u_222.Parent = v_u_183
		end
	end
	createMapSetting(v_u_184.Scripts, "SaveScripts", true)
	createMapSetting(v_u_184.Terrain, "SaveTerrain", true)
	createMapSetting(v_u_184.Lighting, "LightingProperties", true)
	createMapSetting(v_u_184.CameraInstances, "CameraInstances", true)
	...
	v_u_185.Text = tostring(game.PlaceId) .. "MapCopy"
	v_u_186.MouseButton1Click:connect(function()
		local v225 = {}
		local v226 = Instance.new("Model", game.ReplicatedStorage)
		local v227 = v_u_188.SaveScripts
		local v228 = v_u_188.SaveTerrain
		local v229 = v_u_188.LightingProperties
		local v230 = v_u_188.CameraInstances
		for v231, v232 in pairs(v_u_188.CopyWhat) do
			if v232 then
				table.insert(v225, v231)
			end
		end
		local v_u_233 = printconsole or writeconsole
		if v_u_233 then
			v_u_233("Raspberry Pi's place copier loaded.")
			v_u_233("Copying map of game " .. tostring(game.PlaceId) .. ".")
		end
		function archivable(p234)
			for _, v235 in pairs(p234:GetChildren()) do
				if not game.Players:GetPlayerFromCharacter(v235) then
					v235.Archivable = true
					archivable(v235)
				end
			end
		end
		function decompileS(p236)
			for _, v_u_237 in pairs(p236:GetChildren()) do
				pcall(function()
					if v_u_237:IsA("LocalScript") then
						local v238 = v_u_237.Disabled
						v_u_237.Disabled = true
						v_u_237.Source = decompile(v_u_237)
						v_u_237.Disabled = v238
						if v_u_237.Source == "" then
							if v_u_233 then
								v_u_233("LocalScript " .. v_u_237.Name .. " had a problem decompiling.")
								return
							end
						elseif v_u_233 then
							v_u_233("LocalScript " .. v_u_237.Name .. " decompiled.")
							return
						end
					elseif v_u_237:IsA("ModuleScript") then
						v_u_237.Source = decompile(v_u_237)
						if v_u_237.Source == "" then
							if v_u_233 then
								v_u_233("ModuleScript " .. v_u_237.Name .. " had a problem decompiling.")
								return
							end
						elseif v_u_233 then
							v_u_233("ModuleScript " .. v_u_237.Name .. " decompiled.")
						end
					end
				end)
				decompileS(v_u_237)
		...
		for _, v239 in pairs(v225) do
			archivable(game[v239])
		end
		for _, v240 in pairs(v225) do
			if v240 == "StarterPlayer" then
				local v241 = Instance.new("Model", v226)
				v241.Name = "StarterPlayer"
				for _, v242 in pairs(game[v240]:GetChildren()) do
					local v243 = Instance.new("Folder", v241)
					v243.Name = v242.Name
					for _, v244 in pairs(v242:GetChildren()) do
						if v244.Name ~= "ControlScript" and v244.Name ~= "CameraScript" then
							v244:Clone().Parent = v243
						end
					end
				end
			else
				local v_u_245 = Instance.new("Folder", v226)
				v_u_245.Name = v240
				for _, v_u_246 in pairs(game[v240]:GetChildren()) do
					if v_u_246 ~= v226 then
						pcall(function()
							v_u_246:Clone().Parent = v_u_245
						end)
					end
				end
			end
		end
		if workspace.CurrentCamera and v230 then
			local v247 = Instance.new("Model", v226)
			v247.Name = "CameraItems"
			for _, v248 in pairs(workspace.CurrentCamera:GetChildren()) do
				v248:Clone().Parent = v247
			end
		end
		if v228 then
			workspace.Terrain:CopyRegion(workspace.Terrain.MaxExtents).Parent = v226
		end
		function saveProp(p249, p_u_250, p_u_251)
			local v_u_252 = p249[p_u_250]
			if type(v_u_252) == "boolean" then
				local v253 = Instance.new("BoolValue", p_u_251)
				v253.Name = p_u_250
				v253.Value = v_u_252
				return
			elseif type(v_u_252) == "number" then
				local v254 = Instance.new("IntValue", p_u_251)
				v254.Name = p_u_250
				v254.Value = v_u_252
				return
			elseif type(v_u_252) == "string" then
				local v255 = Instance.new("StringValue", p_u_251)
				v255.Name = p_u_250
				v255.Value = v_u_252
			elseif type(v_u_252) == "userdata" then
				pcall(function()
					local v256 = Instance.new("Color3Value", p_u_251)
					v256.Name = p_u_250
					v256.Value = v_u_252
				end)
			end
		...
		if v229 then
			local v257 = Instance.new("Model", v226)
			v257.Name = "LightingProperties"
			saveProp(game.Lighting, "Ambient", v257)
			saveProp(game.Lighting, "Brightness", v257)
			saveProp(game.Lighting, "ColorShift_Bottom", v257)
			saveProp(game.Lighting, "ColorShift_Top", v257)
			saveProp(game.Lighting, "GlobalShadows", v257)
			saveProp(game.Lighting, "OutdoorAmbient", v257)
			saveProp(game.Lighting, "Outlines", v257)
			saveProp(game.Lighting, "GeographicLatitude", v257)
			saveProp(game.Lighting, "TimeOfDay", v257)
			saveProp(game.Lighting, "FogColor", v257)
			saveProp(game.Lighting, "FogEnd", v257)
			saveProp(game.Lighting, "FogStart", v257)
		end
		if decompile and v227 then
			decompileS(v226)
		end
		if SaveInstance then
			SaveInstance(v226, v_u_185.Text .. ".rbxm")
		elseif saveinstance then
			saveinstance(getelysianpath() .. v_u_185.Text .. ".rbxm", v226)
		end
		if v_u_233 then
			v_u_233("The map has been copied.")
		end
		v_u_186.Text = "The map has been saved"
		wait(5)
		v_u_186.Text = "Save"
	end)
	wait()
	v166:TweenPosition(UDim2.new(1, -300, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.5, true)
	switchWindows("Explorer")
	wait(1)
	v_u_167.Visible = true
	for v258 = 0, 1, 0.1 do
		v166.BackgroundTransparency = v258
		v166.Main.BackgroundTransparency = v258
		v166.Slant.ImageTransparency = v258
		v166.Title.TextTransparency = v258
		v166.Version.TextTransparency = v258
		v166.Creator.TextTransparency = v258
		wait()
	end
	v166.Visible = false
	v_u_172:TweenPosition(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.5, true)
	v_u_170:TweenPosition(UDim2.new(0, 0, 0, 180), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.5, true)
	v_u_169:TweenPosition(UDim2.new(0, 0, 0, 210), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.5, true)
	v173:TweenPosition(UDim2.new(0, 0, 0, 240), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.5, true)
	wait(0.5)
	for v259 = 1, 0, -0.1 do
		v_u_170.Icon.ImageTransparency = v259
		v_u_169.TextTransparency = v259
		wait()
	end
	v_u_169.Active = true
	v_u_169.AutoButtonColor = true
	v_u_170.Active = true
	v_u_170.AutoButtonColor = true
end)
spawn(function()
	local v_u_260 = { ["Modifiable"] = false, ["Selectable"] = true, ["Modifiable"] = true }
	local v261 = game:GetService("UserInputService")
	local v_u_262 = false
	local v_u_263 = false
	local v264 = { 8, 9, 10, 11, 12, 14, 18, 24, 36, 48 }
	local _ = math.huge
	local v_u_265 = nil
	for v266 = 1, #v264 do
		if v264[v266] <= 16 then
			v_u_265 = v266 - 1
		end
	end
	local v_u_267 = {
	...
	function Create(p269, p270)
		if type(p269) == "string" then
			p269 = Instance.new(p269)
		end
		for v271, v272 in pairs(p270) do
	...
	local v_u_273 = false
	local v_u_274 = {}
	function createDDown(p_u_275, p_u_276, ...)
		if v_u_273 then
			for _, v277 in pairs(v_u_274) do
				v277:Destroy()
			end
			v_u_274 = {}
			v_u_273 = false
			...
			v_u_273 = true
			local v_u_278 = { ... }
			for v_u_279, _ in pairs(v_u_278) do
				local v280 = p_u_275:Clone()
				v280.ZIndex = 5
				v280.Name = "Option " .. tostring(v_u_279)
				v280.Parent = p_u_275.Parent.Parent.Parent
				v280.BackgroundTransparency = 0
				v280.ZIndex = 2
				table.insert(v_u_274, v280)
				v280.Position = UDim2.new(
					-0.4,
					p_u_275.Position.X.Offset,
					p_u_275.Position.Y.Scale,
					p_u_275.Position.Y.Offset + #v_u_274 * p_u_275.Size.Y.Offset
				)
				v280.Text = v_u_278[v_u_279]
				v280.MouseButton1Down:connect(function()
					p_u_275.Text = v_u_278[v_u_279]
					p_u_276(v_u_278[v_u_279])
					for _, v281 in pairs(v_u_274) do
						v281:Destroy()
					end
					v_u_274 = {}
					v_u_273 = false
	...
	function Connect(p282, p_u_283)
		return p282:connect(function(...)
			local v_u_284 = { ... }
			spawn(function()
				p_u_283(unpack(v_u_284))
			end)
		end)
	end
	function GetScreen(p285)
		if p285 == nil then
			return nil
		end
		while not p285:IsA("ScreenGui") do
			p285 = p285.Parent
			if p285 == nil then
				return nil
			end
	...
	local v_u_286 = {}
	function SetZIndex(p287, p288)
		if not v_u_286[p287] then
			v_u_286[p287] = true
			if p287:IsA("GuiObject") then
				p287.ZIndex = p288
			end
			local v289 = p287:GetChildren()
			for v290 = 1, #v289 do
				SetZIndex(v289[v290], p288)
			end
			v_u_286[p287] = nil
		end
	end
	function SetZIndexOnChanged(p_u_291)
		return p_u_291.Changed:connect(function(p292)
			if p292 == "ZIndex" then
				SetZIndex(p_u_291, p_u_291.ZIndex)
			end
		end)
	end
	local v_u_293 = "http://www.roblox.com/asset/?id=" .. 483448923
	game:GetService("ContentProvider"):Preload(v_u_293)
	local v_u_294 = math.floor
	local function v_u_296(p295)
		return v_u_294(p295 / 14 % 14), v_u_294(p295 % 14)
	end
	local function v_u_304(p297, p298)
		local v299, v300 = v_u_296(p298)
		local v301 = Vector2.new(256, 256)
		local v302
		if type(p297) == "string" then
			v302 = nil
		else
			v302 = p297
			p297 = "Frame"
				...
				p297,
				{
					...
					Create(
						"ImageLabel",
						{
							...
							["BackgroundTransparency"] = 1,
							["Image"] = v_u_293,
							["Size"] = UDim2.new(v301.x / 16, 0, v301.y / 16, 0),
						}
					),
				}
			)
		v303.IconMap.Position = UDim2.new(-v300 - (2 * (v300 + 1) + 1) / 16, 0, -v299 - (2 * (v299 + 1) + 1) / 16, 0)
		return v303
	end
	local function v_u_307(p305)
		local v306 = p305.Active
		p305.Active = not v306
		p305.Active = v306
	end
	local function v_u_343(p_u_308, p309, p310, p311)
		local v312 = Create(
			"Frame",
			{
				["Name"] = "Arrow Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_308, 0, p_u_308),
				["Transparency"] = 1,
			}
		)
		if not p311 then
			p311 = Instance.new("Frame")
			p311.BorderSizePixel = 0
		end
		local v313 = nil
		local v314
		if p309 == nil or p309 == "Up" then
			v314 = function(p315, p316)
				return p315, p316
			end
		elseif p309 == "Down" then
			v314 = function(p317, p318)
				return UDim2.new(0, p317.X.Offset, 0, p_u_308 - p317.Y.Offset - 1), p318
			end
		elseif p309 == "Left" then
			v314 = function(p319, p320)
				return UDim2.new(0, p319.Y.Offset, 0, p319.X.Offset), UDim2.new(0, p320.Y.Offset, 0, p320.X.Offset)
			end
		else
			v314 = p309 == "Right"
					and function(p321, p322)
						return UDim2.new(0, p_u_308 - p321.Y.Offset - 1, 0, p321.X.Offset),
							UDim2.new(0, p322.Y.Offset, 0, p322.X.Offset)
					end
				or v313
		end
		local v327 = p310
				and function(p323, p324)
					return UDim2.new(p323.X.Offset / p_u_308, 0, p323.Y.Offset / p_u_308, 0),
						UDim2.new(p324.X.Offset / p_u_308, 0, p324.Y.Offset / p_u_308, 0)
				end
			or function(p325, p326)
				return p325, p326
			end
		local v328 = p_u_308 / 4
		local v329 = math.floor(v328)
		if p_u_308 % 2 == 0 then
			local v330 = p_u_308 / 2 - 1
			for v331 = 0, v330 do
				local v332 = p311:Clone()
				local v333, v334 =
					v327(v314(UDim2.new(0, v330 - v331, 0, v329 + v331), UDim2.new(0, (v331 + 1) * 2, 0, 1)))
				v332.Position = v333
				v332.Size = v334
				v332.Parent = v312
			end
		else
			local v335 = (p_u_308 - 1) / 2
			for v336 = 0, v335 do
				local v337 = p311:Clone()
				local v338, v339 =
					v327(v314(UDim2.new(0, v335 - v336, 0, v329 + v336), UDim2.new(0, v336 * 2 + 1, 0, 1)))
				v337.Position = v338
				v337.Size = v339
				v337.Parent = v312
			end
		...
		if 1 < p_u_308 % 4 then
			local v340 = p311:Clone()
			local v341, v342 = v327(v314(UDim2.new(0, 0, 0, p_u_308 - v329 - 1), UDim2.new(0, p_u_308, 0, 1)))
			v340.Position = v341
			v340.Size = v342
			v340.Parent = v312
		end
	...
	local function v_u_358(p_u_344, p345, p346, p347, p348)
		local v349 = Create(
			"Frame",
			{
				["Name"] = "Grip Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_344.x, 0, p_u_344.y),
				["Transparency"] = 1,
			}
		)
		if not p348 then
			p348 = Instance.new("Frame")
			p348.BorderSizePixel = 0
		end
		local v350 = p346 or 2
		local v353 = p347
				and function(p351)
					return UDim2.new(p351.X.Offset / p_u_344.x, 0, p351.Y.Offset / p_u_344.y, 0)
				end
			or function(p352)
				return p352
			end
		if p345 == "Vertical" then
			for v354 = 0, p_u_344.x - 1, v350 do
				local v355 = p348:Clone()
				v355.Size = v353(UDim2.new(0, 1, 0, p_u_344.y))
				v355.Position = v353(UDim2.new(0, v354, 0, 0))
				v355.Parent = v349
			end
			return v349
		else
			if p345 == nil or p345 == "Horizontal" then
				for v356 = 0, p_u_344.y - 1, v350 do
					local v357 = p348:Clone()
					v357.Size = v353(UDim2.new(0, p_u_344.x, 0, 1))
					v357.Position = v353(UDim2.new(0, 0, 0, v356))
					v357.Parent = v349
				end
			end
			return v349
	...
	local v_u_369 = {
		["__index"] = {
			["GetScrollPercent"] = function(p359)
				return p359.ScrollIndex / (p359.TotalSpace - p359.VisibleSpace)
			end,
			["CanScrollDown"] = function(p360)
				return p360.ScrollIndex + p360.VisibleSpace < p360.TotalSpace
			end,
			["CanScrollUp"] = function(p361)
				return 0 < p361.ScrollIndex
			end,
			["ScrollDown"] = function(p362)
				p362.ScrollIndex = p362.ScrollIndex + p362.PageIncrement
				p362:Update()
			end,
			["ScrollUp"] = function(p363)
				p363.ScrollIndex = p363.ScrollIndex - p363.PageIncrement
				p363:Update()
			end,
			["ScrollTo"] = function(p364, p365)
				p364.ScrollIndex = p365
				p364:Update()
			end,
			["SetScrollPercent"] = function(p366, p367)
				local v368 = (p366.TotalSpace - p366.VisibleSpace) * p367 + 0.5
				p366.ScrollIndex = math.floor(v368)
				p366:Update()
			end,
		},
	}
	v_u_369.__index.CanScrollRight = v_u_369.__index.CanScrollDown
	v_u_369.__index.CanScrollLeft = v_u_369.__index.CanScrollUp
	v_u_369.__index.ScrollLeft = v_u_369.__index.ScrollUp
	v_u_369.__index.ScrollRight = v_u_369.__index.ScrollDown
	function ScrollBar(p370)
		local v_u_371 = Create(
			"Frame",
			{
				["Name"] = "ScrollFrame",
				["Position"] = p370 and UDim2.new(0, 0, 1, -16) or UDim2.new(1, -16, 0, 0),
				["Size"] = p370 and UDim2.new(1, 0, 0, 16) or UDim2.new(0, 16, 1, 0),
				["BackgroundTransparency"] = 1,
				Create(
					"ImageButton",
					{
						["Name"] = "ScrollDown",
						["Position"] = p370 and UDim2.new(1, -16, 0, 0) or UDim2.new(0, 0, 1, -16),
						["Size"] = UDim2.new(0, 16, 0, 16),
						["BackgroundColor3"] = v_u_267.Button,
						["BorderColor3"] = v_u_267.Border,
					}
				),
				Create(
					"ImageButton",
				...
				Create(
					...
					{
						["Name"] = "ScrollBar",
						["Size"] = p370 and UDim2.new(1, -32, 1, 0) or UDim2.new(1, 0, 1, -32),
						["Position"] = p370 and UDim2.new(0, 16, 0, 0) or UDim2.new(0, 0, 0, 16),
		...
		local v372 =
			Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = v_u_267.Border })
		local v_u_373 = v_u_371.ScrollDown
		local v_u_374 = v_u_343(8, p370 and "Right" or "Down", true, v372)
		v_u_374.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_374.Parent = v_u_373
		local v_u_375 = v_u_371.ScrollUp
		local v_u_376 = v_u_343(8, p370 and "Left" or "Up", true, v372)
		v_u_376.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_376.Parent = v_u_375
		local v_u_377 = v_u_371.ScrollBar
		local v_u_378 = v_u_377.ScrollThumb
		local v379 = v_u_358(Vector2.new(6, 6), p370 and "Vertical" or "Horizontal", 2, v372)
		v379.Position = UDim2.new(0.5, -3, 0.5, -3)
		v379.Parent = v_u_378
		local v_u_380 = setmetatable(
			{ ["GUI"] = v_u_371, ["ScrollIndex"] = 0, ["VisibleSpace"] = 0, ["TotalSpace"] = 0, ["PageIncrement"] = 1 },
			v_u_369
		)
		local v_u_383 = p370
				and function()
					v_u_378.Size = UDim2.new(v_u_380.VisibleSpace / v_u_380.TotalSpace, 0, 0, 16)
					if v_u_378.AbsoluteSize.x < 16 then
						v_u_378.Size = UDim2.new(0, 16, 0, 16)
					end
					local v381 = v_u_377.AbsoluteSize.x
					v_u_378.Position =
						UDim2.new(v_u_380:GetScrollPercent() * (v381 - v_u_378.AbsoluteSize.x) / v381, 0, 0, 0)
				end
			or function()
				v_u_378.Size = UDim2.new(0, 16, v_u_380.VisibleSpace / v_u_380.TotalSpace, 0)
				if v_u_378.AbsoluteSize.y < 16 then
					v_u_378.Size = UDim2.new(0, 16, 0, 16)
				end
				local v382 = v_u_377.AbsoluteSize.y
				v_u_378.Position =
					UDim2.new(0, 0, v_u_380:GetScrollPercent() * (v382 - v_u_378.AbsoluteSize.y) / v382, 0)
			end
		local v_u_384 = nil
		local v_u_385 = nil
		local v_u_386 = { ["BackgroundColor3"] = v_u_267.Border, ["BackgroundTransparency"] = 0 }
		local v_u_387 = { ["BackgroundColor3"] = v_u_267.Border, ["BackgroundTransparency"] = 0.7 }
		local function v399()
			local v388 = v_u_380.TotalSpace
			local v389 = v_u_380.VisibleSpace
			local v390 = v_u_380.ScrollIndex
			if v389 <= v388 then
				if 0 < v390 then
					if v388 < v390 + v389 then
						v_u_380.ScrollIndex = v388 - v389
					end
				else
					v_u_380.ScrollIndex = 0
				end
			else
				v_u_380.ScrollIndex = 0
			end
			if not v_u_380.UpdateCallback or v_u_380.UpdateCallback(v_u_380) ~= false then
				local v391 = v_u_380:CanScrollDown()
				local v392 = v_u_380:CanScrollUp()
				if v391 ~= v_u_384 then
					v_u_384 = v391
					v_u_373.Active = v391
					v_u_373.AutoButtonColor = v391
					local v393 = v_u_374:GetChildren()
					local v394 = v391 and v_u_386
					if not v394 then
						v394 = v_u_387
					end
					for v395 = 1, #v393 do
						Create(v393[v395], v394)
					end
				end
				if v392 ~= v_u_385 then
					v_u_385 = v392
					v_u_375.Active = v392
					v_u_375.AutoButtonColor = v392
					local v396 = v_u_376:GetChildren()
					local v397 = v392 and v_u_386
					if not v397 then
						v397 = v_u_387
					end
					for v398 = 1, #v396 do
						Create(v396[v398], v397)
					end
				end
				v_u_378.Visible = v391 or v392
				v_u_383()
			end
		end
		v_u_380.Update = v399
		SetZIndexOnChanged(v_u_371)
		local v_u_400 = Create(
			"ImageButton",
			{
				["Name"] = "MouseDrag",
		...
		local v_u_401 = 0
		v_u_373.MouseButton1Down:connect(function()
			v_u_401 = tick()
			local v402 = v_u_401
			local v_u_403 = nil
			v_u_403 = v_u_400.MouseButton1Up:connect(function()
				v_u_401 = tick()
				v_u_400.Parent = nil
				v_u_307(v_u_373)
				v_u_403:disconnect()
			...
			v_u_400.Parent = GetScreen(v_u_371)
			v_u_380:ScrollDown()
			wait(0.2)
			while v_u_401 == v402 do
				v_u_380:ScrollDown()
				if not v_u_380:CanScrollDown() then
					break
				end
				wait()
			end
		end)
		v_u_373.MouseButton1Up:connect(function()
			v_u_401 = tick()
		end)
		v_u_375.MouseButton1Down:connect(function()
			v_u_401 = tick()
			local v404 = v_u_401
			local v_u_405 = nil
			v_u_405 = v_u_400.MouseButton1Up:connect(function()
				v_u_401 = tick()
				v_u_400.Parent = nil
				v_u_307(v_u_375)
				v_u_405:disconnect()
			...
			v_u_380:ScrollUp()
			wait(0.2)
			while v_u_401 == v404 do
				v_u_380:ScrollUp()
				if not v_u_380:CanScrollUp() then
					break
				end
				wait()
			end
		end)
		v_u_375.MouseButton1Up:connect(function()
			v_u_401 = tick()
		end)
		if p370 then
			v_u_377.MouseButton1Down:connect(function(p406, _)
				v_u_401 = tick()
				local v407 = v_u_401
				local v_u_408 = nil
				v_u_408 = v_u_400.MouseButton1Up:connect(function()
					v_u_401 = tick()
					v_u_400.Parent = nil
					v_u_307(v_u_375)
					v_u_408:disconnect()
				...
				v_u_400.Parent = GetScreen(v_u_371)
				if v_u_378.AbsolutePosition.x < p406 then
					v_u_380:ScrollTo(v_u_380.ScrollIndex + v_u_380.VisibleSpace)
					wait(0.2)
					while v_u_401 == v407 and p406 >= v_u_378.AbsolutePosition.x + v_u_378.AbsoluteSize.x do
						v_u_380:ScrollTo(v_u_380.ScrollIndex + v_u_380.VisibleSpace)
						wait()
					end
				else
					v_u_380:ScrollTo(v_u_380.ScrollIndex - v_u_380.VisibleSpace)
					wait(0.2)
					while v_u_401 == v407 and v_u_378.AbsolutePosition.x >= p406 do
						v_u_380:ScrollTo(v_u_380.ScrollIndex - v_u_380.VisibleSpace)
						wait()
					end
				end
			...
			v_u_377.MouseButton1Down:connect(function(_, p409)
				v_u_401 = tick()
				local v410 = v_u_401
				local v_u_411 = nil
				v_u_411 = v_u_400.MouseButton1Up:connect(function()
					v_u_401 = tick()
					v_u_400.Parent = nil
					v_u_307(v_u_375)
					v_u_411:disconnect()
				...
				v_u_400.Parent = GetScreen(v_u_371)
				if v_u_378.AbsolutePosition.y < p409 then
					v_u_380:ScrollTo(v_u_380.ScrollIndex + v_u_380.VisibleSpace)
					wait(0.2)
					while v_u_401 == v410 and p409 >= v_u_378.AbsolutePosition.y + v_u_378.AbsoluteSize.y do
						v_u_380:ScrollTo(v_u_380.ScrollIndex + v_u_380.VisibleSpace)
						wait()
					end
				else
					v_u_380:ScrollTo(v_u_380.ScrollIndex - v_u_380.VisibleSpace)
					wait(0.2)
					while v_u_401 == v410 and v_u_378.AbsolutePosition.y >= p409 do
						v_u_380:ScrollTo(v_u_380.ScrollIndex - v_u_380.VisibleSpace)
						wait()
					end
				end
		...
		if p370 then
			v_u_378.MouseButton1Down:connect(function(p412, _)
				v_u_401 = tick()
				local v_u_413 = p412 - v_u_378.AbsolutePosition.x
				local v_u_414 = nil
				local v_u_420 = v_u_400.MouseMoved:connect(function(p415, _)
					local v416 = v_u_377.AbsolutePosition.x
					local v417 = v_u_377.AbsoluteSize.x - v_u_378.AbsoluteSize.x
					local v418 = v416 + v417
					local v419 = p415 - v_u_413
					if v419 < v416 and v416 then
						v419 = v416
					elseif v418 < v419 then
						if v418 then
							v419 = v418
						end
					end
					v_u_380:SetScrollPercent((v419 - v416) / v417)
				end)
				v_u_414 = v_u_400.MouseButton1Up:connect(function()
					v_u_401 = tick()
					v_u_400.Parent = nil
					v_u_307(v_u_378)
					v_u_420:disconnect()
			...
			v_u_378.MouseButton1Down:connect(function(_, p421)
				v_u_401 = tick()
				local v_u_422 = p421 - v_u_378.AbsolutePosition.y
				local v_u_423 = nil
				local v_u_429 = v_u_400.MouseMoved:connect(function(_, p424)
					local v425 = v_u_377.AbsolutePosition.y
					local v426 = v_u_377.AbsoluteSize.y - v_u_378.AbsoluteSize.y
					local v427 = v425 + v426
					local v428 = p424 - v_u_422
					if v428 < v425 and v425 then
						v428 = v425
					elseif v427 < v428 then
						if v427 then
							v428 = v427
						end
					end
					v_u_380:SetScrollPercent((v428 - v425) / v426)
				end)
				v_u_423 = v_u_400.MouseButton1Up:connect(function()
					v_u_401 = tick()
					v_u_400.Parent = nil
					v_u_307(v_u_378)
					v_u_429:disconnect()
		...
		function v_u_380.Destroy(_)
			v_u_371:Destroy()
			v_u_400:Destroy()
			for v430 in pairs(v_u_380) do
				v_u_380[v430] = nil
			end
			setmetatable(v_u_380, nil)
		end
		v399()
		return v_u_380
	end
	local v_u_431 = v_u_164.ExplorerPanel
	Create(v_u_431, { ["BackgroundColor3"] = v_u_267.Field, ["BorderColor3"] = v_u_267.Border, ["Active"] = true })
	local v_u_432 = v_u_431.Parent:WaitForChild("SettingsPanel"):WaitForChild("GetSetting")
	local v433 = v_u_431.Parent:WaitForChild("PropertiesFrame"):WaitForChild("GetApi")
	local v_u_434 = v_u_431.Parent:WaitForChild("PropertiesFrame"):WaitForChild("GetAwaiting")
	local v_u_435 = v_u_431.Parent:WaitForChild("PropertiesFrame"):WaitForChild("SetAwaiting")
	local v_u_436 = v_u_431.Parent:WaitForChild("SaveInstance")
	local v_u_437 = v_u_431.Parent:WaitForChild("Confirmation")
	local v_u_438 = v_u_431.Parent:WaitForChild("Caution")
	local v_u_439 = v_u_431.Parent:WaitForChild("TableCaution")
	local v_u_440 = v_u_431.Parent:WaitForChild("CallRemote")
	local v_u_441 = v_u_431.Parent:WaitForChild("ScriptEditor"):WaitForChild("OpenScript")
	local v_u_442 = nil
	local v_u_443 = nil
	local v_u_444 = nil
	local v_u_445 = nil
	local v_u_446 = nil
	local v_u_447 = saveinstance and true or nil
	if v_u_447 then
		v_u_445 = Instance.new("Folder")
		v_u_445.Name = "Dex"
		v_u_446 = Instance.new("Folder", v_u_445)
		v_u_446.Name = "DexStorage"
	end
	local v_u_448 = nil
	local v_u_449 = nil
	local v_u_450 = nil
	if get_nil_instances then
		v_u_450 = IfThisFunctionWasStableEnough and true or v_u_450
	end
	if v_u_450 then
		v_u_448 = Instance.new("Folder")
		v_u_448.Name = "Dex Internal Storage"
		v_u_449 = Instance.new("Folder", v_u_448)
		v_u_449.Name = "Nil Instances"
	end
	local v_u_451 = Create(
		"Frame",
		{
			["Name"] = "List",
			["BackgroundTransparency"] = 1,
	...
	local v_u_452 = ScrollBar(false)
	v_u_452.PageIncrement = 1
	Create(
		v_u_452.GUI,
		{ ["Position"] = UDim2.new(1, -16, 0, 36), ["Size"] = UDim2.new(0, 16, 1, -36), ["Parent"] = v_u_431 }
	)
	local v_u_453 = ScrollBar(true)
	v_u_453.PageIncrement = 16
	Create(
		v_u_453.GUI,
		{
	...
	local v_u_454 = Create(
		"Frame",
		{
			["Name"] = "Header",
			["BackgroundColor3"] = v_u_267.Background,
			["BorderColor3"] = v_u_267.Border,
	...
	v_u_455.Parent = v_u_454
	SetZIndexOnChanged(v_u_431)
	local function v459(p456, p457, p458)
		return Color3.new(p456 / 255, p457 / 255, p458 / 255)
	end
	local v460 =
		{ ["Font"] = Enum.Font.Arial, ["Margin"] = 5, ["Black"] = v459(0, 0, 0), ["White"] = v459(255, 255, 255) }
	local v_u_461 = {
		["Font"] = v460.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextColor"] = v459(0, 0, 0),
		["TextColorOver"] = v460.White,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["Height"] = 20,
		["BackColor"] = v460.White,
		["BackColorOver"] = v459(86, 125, 188),
		["BorderColor"] = v459(216, 216, 216),
		["BorderSizePixel"] = 2,
		["ArrowColor"] = v459(160, 160, 160),
		["ArrowColorOver"] = v460.Black,
	}
	local _ = {
		["Font"] = v460.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["TextColor"] = v460.Black,
		["TextColorOver"] = v460.White,
		["TextLockedColor"] = v459(120, 120, 120),
		["Height"] = 24,
		["BorderColor"] = v459(216, 216, 216),
		["BackgroundColor"] = v460.White,
		["BackgroundColorAlternate"] = v459(246, 246, 246),
		["BackgroundColorMouseover"] = v459(211, 224, 244),
		["TitleMarginLeft"] = 15,
	}
	local v_u_462 = nil
	local v_u_463 = nil
	local v_u_464 = nil
	local v_u_465 = nil
	function ClassCanCreate(p_u_466)
		local _, v467 = pcall(function()
			Instance.new(p_u_466)
		end)
		return not v467
	end
	function GetClasses()
		...
		local v468 = {}
		for _, v469 in pairs(v_u_465.Classes) do
			if ClassCanCreate(v469.Name) then
				local v470 = v469.Name
				table.insert(v468, v470)
			end
		end
		return v468
	end
	local function v_u_475(p471, p_u_472)
		table.sort(p471, function(p473, p474)
			return p473[p_u_472] < p474[p_u_472]
		end)
	end
	local function v_u_479(p476)
		local v477 = p476.tags
		for _, v478 in pairs(v477) do
			if v478 == "deprecated" or v478 == "hidden" or v478 == "writeonly" then
				return true
			end
		end
		return false
	end
	local function v_u_484(p480)
		local v481 = v_u_465.Classes[p480]
		local v482 = {}
		if not v481 then
			return v482
		end
		while v481 and v481.Name ~= "Instance" do
			for _, v483 in pairs(v481.Functions) do
				if not v_u_479(v483) then
					table.insert(v482, v483)
				end
			end
			v481 = v_u_465.Classes[v481.Superclass]
		end
		v_u_475(v482, "Name")
		return v482
	end
	function GetFunctions()
		...
		local v485 = SelectionVar():Get()
		if #v485 ~= 0 then
			local v486 = v485[1]
			local v487 = {}
			for _, v488 in pairs(v_u_484(v486.ClassName)) do
				table.insert(v487, v488)
			end
			return v487
		end
	end
	function CreateInsertObjectMenu(p_u_489, _, _, p_u_490)
		game.Players.LocalPlayer:GetMouse()
		local _ = v_u_431.Parent.AbsoluteSize.y
		if #p_u_489 ~= 0 then
			table.sort(p_u_489, function(p491, p492)
				return p491 < p492
			end)
			local v_u_493 = Instance.new("Frame")
			v_u_493.Name = "InsertObject"
			v_u_493.Size = UDim2.new(0, 200, 1, 0)
			v_u_493.BackgroundTransparency = 1
			v_u_493.Active = true
			local v_u_494 = nil
			local v_u_495 = false
			local v_u_496 = v_u_461.BorderSizePixel
			local function v_u_497()
				v_u_495 = false
				if v_u_493 then
					v_u_463.Visible = false
				end
			end
			(function()
				v_u_495 = true
				v_u_494 = Instance.new("ScrollingFrame")
				v_u_494.Size = UDim2.new(0, 200, 1, 0)
				v_u_494.CanvasSize = UDim2.new(0, 200, 0, #p_u_489 * v_u_461.Height)
				v_u_494.Position = UDim2.new(0, v_u_496, 0, 0)
				v_u_494.BackgroundTransparency = 0
				v_u_494.BackgroundColor3 = v_u_461.BackColor
				v_u_494.BorderColor3 = v_u_461.BorderColor
				v_u_494.BorderSizePixel = v_u_461.BorderSizePixel
				v_u_494.TopImage = "rbxasset://textures/blackBkg_square.png"
				v_u_494.MidImage = "rbxasset://textures/blackBkg_square.png"
				v_u_494.BottomImage = "rbxasset://textures/blackBkg_square.png"
				v_u_494.Active = true
				v_u_494.ZIndex = 5
				v_u_494.Parent = v_u_493
				local function v_u_499(p498)
					p_u_490(p498)
					v_u_497()
				end
				for v500, v_u_501 in pairs(p_u_489) do
					local v502 = CreateRightClickMenuItem(v_u_501, function()
						v_u_499(v_u_501)
					end, 1)
					v502.Size = UDim2.new(1, 0, 0, 20)
					v502.Position = UDim2.new(0, 0, 0, (v500 - 1) * v_u_461.Height)
					v502.ZIndex = v_u_494.ZIndex
					v502.Parent = v_u_494
				end
			end)()
			return v_u_493
	...
	function CreateFunctionCallerMenu(p_u_503, _, _, p_u_504)
		game.Players.LocalPlayer:GetMouse()
		local _ = v_u_431.Parent.AbsoluteSize.y
		if #p_u_503 ~= 0 then
			table.sort(p_u_503, function(p505, p506)
				return p505.Name < p506.Name
			end)
			local v_u_507 = Instance.new("Frame")
			v_u_507.Name = "InsertObject"
			v_u_507.Size = UDim2.new(0, 200, 1, 0)
			v_u_507.BackgroundTransparency = 1
			v_u_507.Active = true
			local v_u_508 = nil
			local v_u_509 = false
			local v_u_510 = v_u_461.BorderSizePixel
			...
			(function()
				v_u_509 = true
				v_u_508 = Instance.new("ScrollingFrame")
				v_u_508.Size = UDim2.new(0, 300, 1, 0)
				v_u_508.CanvasSize = UDim2.new(0, 300, 0, #p_u_503 * v_u_461.Height)
				v_u_508.Position = UDim2.new(0, v_u_510, 0, 0)
				v_u_508.BackgroundTransparency = 0
				v_u_508.BackgroundColor3 = v_u_461.BackColor
				v_u_508.BorderColor3 = v_u_461.BorderColor
				v_u_508.BorderSizePixel = v_u_461.BorderSizePixel
				v_u_508.TopImage = "rbxasset://textures/blackBkg_square.png"
				v_u_508.MidImage = "rbxasset://textures/blackBkg_square.png"
				v_u_508.BottomImage = "rbxasset://textures/blackBkg_square.png"
				v_u_508.Active = true
				v_u_508.ZIndex = 5
				v_u_508.Parent = v_u_507
				local function v518(p512)
					local v513 = "" .. "("
					for v514, v515 in pairs(p512.Arguments) do
						local v516 = v515.Type
						local v517 = v515.Name
						v513 = v513 .. v516 .. " " .. v517
						if v514 < #p512.Arguments then
							v513 = v513 .. ", "
						end
					end
					return v513 .. ")"
				end
				local function v_u_520(p519)
					p_u_504(p519)
					v_u_511()
				end
				for v521, v_u_522 in pairs(p_u_503) do
					local v523 = CreateRightClickMenuItem
					local v524 = v_u_522.ReturnType
					local v525 = v_u_522.Name
					local v526 = v518(v_u_522)
					local v527 = v523(v524 .. " " .. v525 .. v526, function()
						v_u_520(v_u_522)
					end, 2)
					v527.Size = UDim2.new(1, 0, 0, 20)
					v527.Position = UDim2.new(0, 0, 0, (v521 - 1) * v_u_461.Height)
					v527.ZIndex = v_u_508.ZIndex
					v527.Parent = v_u_508
				end
			end)()
			return v_u_507
	...
	function CreateInsertObject()
		if v_u_463 then
			v_u_463.Visible = true
			if v_u_462 and v_u_463.Visible then
				v_u_463.Position = UDim2.new(0, v_u_462.Position.X.Offset - v_u_462.Size.X.Offset - 2, 0, 0)
			end
			if v_u_463.Visible then
				v_u_463.Parent = v_u_431.Parent
			end
		end
	end
	function CreateFunctionCaller()
		...
		v_u_464 = CreateFunctionCallerMenu(GetFunctions(), "", false, function(p_u_528)
			v_u_464:Destroy()
			v_u_464 = nil
			local v_u_529 = SelectionVar():Get()
			for v_u_530 = 1, #v_u_529 do
				pcall(function()
					Instance.new(p_u_528, v_u_529[v_u_530])
				end)
			end
			print(p_u_528.Name .. " selected to be called. Function caller being added soon, please wait!")
			DestroyRightClick()
		end)
		if v_u_462 and v_u_464 then
			v_u_464.Position = UDim2.new(0, v_u_462.Position.X.Offset - v_u_462.Size.X.Offset * 1.5 - 2, 0, 0)
		end
		if v_u_464 then
			v_u_464.Parent = v_u_431.Parent
		end
	end
	function CreateRightClickMenuItem(p_u_531, p_u_532, p_u_533)
		local v_u_534 = Instance.new("TextButton")
		v_u_534.Font = v_u_461.Font
		v_u_534.FontSize = v_u_461.FontSize
		v_u_534.TextColor3 = v_u_461.TextColor
		v_u_534.TextXAlignment = v_u_461.TextXAlignment
		v_u_534.BackgroundColor3 = v_u_461.BackColor
		v_u_534.AutoButtonColor = false
		v_u_534.BorderSizePixel = 0
		v_u_534.Active = true
		v_u_534.Text = p_u_531
		if p_u_533 == 1 then
			local v535 = v_u_304(nil, v_u_268[p_u_531] or 0)
			v535.Position = UDim2.new(0, 0, 0, 2)
			v535.Size = UDim2.new(0, 16, 0, 16)
			v535.IconMap.ZIndex = 5
			v535.Parent = v_u_534
			v_u_534.Text = "\t\t" .. v_u_534.Text
		elseif p_u_533 == 2 then
			v_u_534.FontSize = Enum.FontSize.Size11
		end
		v_u_534.MouseEnter:connect(function()
			v_u_534.TextColor3 = v_u_461.TextColorOver
			v_u_534.BackgroundColor3 = v_u_461.BackColorOver
			if not p_u_533 and v_u_463 then
				if v_u_463.Visible == false and v_u_534.Text == "Insert Object" then
					CreateInsertObject()
				elseif v_u_463.Visible and v_u_534.Text ~= "Insert Object" then
					v_u_463.Visible = false
				end
			end
			if not p_u_533 then
				if v_u_464 and v_u_534.Text ~= "Call Function" then
					v_u_464:Destroy()
					v_u_464 = nil
					return
				end
				if v_u_534.Text == "Call Function" then
					CreateFunctionCaller()
				end
			end
		end)
		v_u_534.MouseLeave:connect(function()
			v_u_534.TextColor3 = v_u_461.TextColor
			v_u_534.BackgroundColor3 = v_u_461.BackColor
		end)
		v_u_534.MouseButton1Click:connect(function()
			v_u_534.TextColor3 = v_u_461.TextColor
			v_u_534.BackgroundColor3 = v_u_461.BackColor
			p_u_532(p_u_531)
		end)
	...
	function CreateRightClickMenu(p_u_536, _, _, p_u_537)
		game.Players.LocalPlayer:GetMouse()
		local v_u_538 = Instance.new("Frame")
		v_u_538.Name = "DropDown"
		v_u_538.Size = UDim2.new(0, 200, 1, 0)
		v_u_538.BackgroundTransparency = 1
		v_u_538.Active = true
		local v_u_539 = nil
		local v_u_540 = false
		local v_u_541 = v_u_461.BorderSizePixel
		local function v_u_542()
			v_u_540 = false
			if v_u_538 then
				v_u_538:Destroy()
				DestroyRightClick()
		...
		(function()
			v_u_540 = true
			v_u_539 = Instance.new("Frame")
			v_u_539.Size = UDim2.new(0, 200, 0, #p_u_536 * v_u_461.Height)
			v_u_539.Position = UDim2.new(0, v_u_541, 0, 5)
			v_u_539.BackgroundTransparency = 0
			v_u_539.BackgroundColor3 = v_u_461.BackColor
			v_u_539.BorderColor3 = v_u_461.BorderColor
			v_u_539.BorderSizePixel = v_u_461.BorderSizePixel
			v_u_539.Active = true
			v_u_539.ZIndex = 5
			v_u_539.Parent = v_u_538
			local function v_u_544(p543)
				p_u_537(p543)
				v_u_542()
			end
			for v545, v_u_546 in pairs(p_u_536) do
				local v547 = CreateRightClickMenuItem(v_u_546, function()
					v_u_544(v_u_546)
				end)
				v547.Size = UDim2.new(1, 0, 0, 20)
				v547.Position = UDim2.new(0, 0, 0, (v545 - 1) * v_u_461.Height)
				v547.ZIndex = v_u_539.ZIndex
				v547.Parent = v_u_539
			end
		end)()
		return v_u_538
	end
	function checkMouseInGui(p548)
		if p548 == nil then
			return false
		end
		local v549 = game.Players.LocalPlayer:GetMouse()
		local v550 = p548.AbsolutePosition
		local v551 = p548.AbsoluteSize
		return v549.X >= v550.x and v549.X <= v550.x + v551.x and v549.Y >= v550.y and v549.Y <= v550.y + v551.y
	end
	local v_u_552 = {}
	local function v_u_554(p553)
		p553.Parent = nil
	end
	local v_u_555 = Create(
		"TextLabel",
		{
			["Name"] = "TextWidth",
			["TextXAlignment"] = "Left",
	...
	local function v_u_557(p556)
		v_u_555.Text = p556
		return v_u_555.TextBounds.x
	end
	local v_u_558 = false
	local v_u_559 = {}
	local v_u_560 = {}
	...
	function filteringWorkspace()
		return v_u_455.Text ~= "" and v_u_455.Text ~= "Filter Workspace"
	end
	function lookForAName(p563, p564)
		for _, v565 in pairs(p563:GetChildren()) do
			if string.find(string.lower(v565.Name), string.lower(p564)) then
				v_u_558 = true
			end
			lookForAName(v565, p564)
		end
	end
	function scanName(p566)
		v_u_558 = false
		if string.find(string.lower(p566.Name), string.lower(v_u_455.Text)) then
			v_u_558 = true
		else
			lookForAName(p566, v_u_455.Text)
		end
		return v_u_558
	end
	function updateActions()
		for _, v567 in pairs(v_u_562) do
			if v567.Cond() then
				v567.Toggle(true)
			else
				v567.Toggle(false)
	...
	local function v_u_571(p568)
		for v569 = 1, #p568 do
			if not filteringWorkspace() or scanName(p568[v569].Object) then
				v_u_559[#v_u_559 + 1] = p568[v569]
				local v570 = p568[v569].Depth * 19 + 2 + 18 + 4 + v_u_557(p568[v569].Object.Name) + 4
				if v_u_561 < v570 then
					v_u_561 = v570
				end
				if p568[v569].Expanded or filteringWorkspace() then
					v_u_571(p568[v569])
				end
			end
		end
	end
	local function v_u_574()
		v_u_453.TotalSpace = v_u_561
		v_u_453.VisibleSpace = v_u_451.AbsoluteSize.x
		v_u_453:Update()
		local v572 = v_u_453:CanScrollDown() or v_u_453:CanScrollUp()
		v_u_453.GUI.Visible = v572
		v_u_451.Size = UDim2.new(1, -16, 1, -16 * (v572 and 1 or 0) - 36)
		local v573 = v_u_451.AbsoluteSize.y / 19
		v_u_452.VisibleSpace = math.ceil(v573)
		v_u_452.GUI.Size = UDim2.new(0, 16, 1, -16 * (v572 and 1 or 0) - 36)
		v_u_452.TotalSpace = #v_u_559 + 1
		v_u_452:Update()
	end
	local function v_u_575()
		v_u_559 = {}
		v_u_561 = 0
		v_u_571(v_u_560[workspace.Parent])
		if v_u_447 then
			v_u_571(v_u_560[v_u_445])
		end
		if v_u_450 then
			v_u_571(v_u_560[v_u_448])
		end
		v_u_574()
		updateActions()
	end
	...
	local v580 = v_u_431:FindFirstChild("TotallyNotGetSelection")
	if not v580 then
		v580 = Create("BindableFunction", { ["Name"] = "TotallyNotGetSelection" })
		v580.Parent = v_u_431
	end
	local v581 = v_u_431:FindFirstChild("TotallyNotSetSelection")
	if not v581 then
		v581 = Create("BindableFunction", { ["Name"] = "TotallyNotSetSelection" })
		v581.Parent = v_u_431
	end
	local v_u_582 = v_u_431:FindFirstChild("TotallyNotSelectionChanged")
	if not v_u_582 then
		v_u_582 = Create("BindableEvent", { ["Name"] = "TotallyNotSelectionChanged" })
		v_u_582.Parent = v_u_431
	end
	local v_u_583 = {}
	local v_u_584 = {}
	local v_u_585 = true
	local v_u_586 = { ["Selected"] = v_u_584, ["List"] = v_u_583 }
	local function v_u_592(p587)
		local v588 = false
		local v589 = false
		if not v_u_584[p587] then
			local v590 = v_u_560[p587]
			if v590 then
				table.insert(v_u_583, p587)
				v_u_584[p587] = true
				v590.Selected = true
				local v591 = v590.Parent
				while v591 do
					if not v591.Expanded then
						v591.Expanded = true
						v588 = true
					end
					v591 = v591.Parent
	...
	function v_u_586.Set(_, p593)
		local v594 = false
		local v595
		if 0 < #v_u_583 then
			for v596 = 1, #v_u_583 do
				local v597 = v_u_583[v596]
				local v598 = v_u_560[v597]
				if v598 then
					v598.Selected = false
					v_u_584[v597] = nil
				end
			...
			v_u_583 = {}
			v_u_586.List = v_u_583
			v595 = true
		else
			v595 = false
		end
		for v599 = 1, #p593 do
			local v600, v601 = v_u_592(p593[v599])
			v595 = v601 or v595
			v594 = v600 or v594
			v595 = v601 or v595
			v594 = v600 or v594
	...
	function v_u_586.Add(_, p602)
		local v603, v604 = v_u_592(p602)
		if v603 then
			v_u_575()
			if v_u_585 then
				v_u_582:Fire()
	...
	function v_u_586.StopUpdates(_)
		v_u_585 = false
	end
	function v_u_586.ResumeUpdates(_)
		v_u_585 = true
		v_u_582:Fire()
		updateActions()
	end
	function v_u_586.Remove(_, p605, p606)
		local v607 = v_u_584[p605] and v_u_560[p605]
		if v607 then
			v607.Selected = false
			v_u_584[p605] = nil
			for v608 = 1, #v_u_583 do
				if v_u_583[v608] == p605 then
					table.remove(v_u_583, v608)
					break
				end
			end
			if not p606 then
	...
	function v_u_586.Get(_)
		local v609 = {}
		for v610 = 1, #v_u_583 do
			v609[v610] = v_u_583[v610]
		end
		return v609
	end
	function v581.OnInvoke(...)
		v_u_586:Set(...)
	end
	function v580.OnInvoke()
		return v_u_586:Get()
	end
	function CreateCaution(p611, p612)
		local v_u_613 = v_u_438:Clone()
		v_u_613.Title.Text = p611
		v_u_613.MainWindow.Desc.Text = p612
		v_u_613.Parent = v_u_431.Parent
		v_u_613.Visible = true
		v_u_613.MainWindow.Ok.MouseButton1Up:connect(function()
			v_u_613:Destroy()
		end)
	end
	function CreateTableCaution(p614, p615)
		if type(p615) ~= "table" then
			return CreateCaution(p614, tostring(p615))
		end
		local v_u_616 = v_u_439:Clone()
		v_u_616.Title.Text = p614
		local v617 = v_u_616.MainWindow.TableResults
		local v618 = v_u_616.MainWindow.TableTemplate
		for _, v619 in pairs(p615) do
			local v620 = v618:Clone()
			v620.Type.Text = type(v619)
			v620.Value.Text = tostring(v619)
			v620.Position = UDim2.new(0, 0, 0, #v617:GetChildren() * 20)
			v620.Parent = v617
			v617.CanvasSize = UDim2.new(0, 0, 0, #v617:GetChildren() * 20)
			v620.Visible = true
		end
		v_u_616.Parent = v_u_431.Parent
		v_u_616.Visible = true
		v_u_616.MainWindow.Ok.MouseButton1Up:connect(function()
			v_u_616:Destroy()
		end)
	end
	local function v_u_629(p621, p622)
		local v623 = {}
		local v624 = 1
		while true do
			local v625 = string.find(p621, p622, v624, true)
			if not v625 then
				break
			end
			local v626 = v625 - 1
			local v627 = string.sub
			table.insert(v623, v627(p621, v624, v626))
			v624 = v625 + string.len(p622)
		end
		local v628 = string.sub
		table.insert(v623, v628(p621, v624))
		return v623
	end
	local function v_u_653(p_u_630, p631)
		if p631 == "Vector2" then
			local v632 = v_u_629(p_u_630, ",")
			if #v632 < 2 then
				return nil
			end
			local v633 = tonumber(v632[1]) or 0
			local v634 = tonumber(v632[2]) or 0
			return Vector2.new(v633, v634)
		end
		if p631 == "Vector3" then
			local v635 = v_u_629(p_u_630, ",")
			if #v635 < 3 then
				return nil
			end
			local v636 = tonumber(v635[1]) or 0
			local v637 = tonumber(v635[2]) or 0
			local v638 = tonumber(v635[3]) or 0
			return Vector3.new(v636, v637, v638)
		end
		if p631 == "Color3" then
			local v639 = v_u_629(p_u_630, ",")
			if #v639 < 3 then
				return nil
			end
			local v640 = tonumber(v639[1]) or 0
			local v641 = tonumber(v639[2]) or 0
			local v642 = tonumber(v639[3]) or 0
			return Color3.new(v640 / 255, v641 / 255, v642 / 255)
		end
		if p631 == "UDim2" then
			local v643 = v_u_629(string.gsub(string.gsub(p_u_630, "{", ""), "}", ""), ",")
			if #v643 < 4 then
				return nil
			end
			local v644 = tonumber(v643[1]) or 0
			local v645 = tonumber(v643[2]) or 0
			local v646 = tonumber(v643[3]) or 0
			local v647 = tonumber(v643[4]) or 0
			return UDim2.new(v644, v645, v646, v647)
		end
		if p631 == "Number" then
			return tonumber(p_u_630)
		end
		if p631 == "String" then
			return p_u_630
		end
		if p631 == "NumberRange" then
			local v648 = v_u_629(p_u_630, ",")
			if #v648 == 1 then
				if tonumber(v648[1]) == nil then
					return nil
				end
				local v649 = tonumber(v648[1]) or 0
				return NumberRange.new(v649)
			end
			if #v648 < 2 then
				return nil
			end
			local v650 = tonumber(v648[1]) or 0
			local v651 = tonumber(v648[2]) or 0
			return NumberRange.new(v650, v651)
		end
		if p631 ~= "Script" then
			return nil
		end
		local _, v652 = ypcall(function()
			_G.D_E_X_DONOTUSETHISPLEASE = nil
			loadstring("_G.D_E_X_DONOTUSETHISPLEASE = " .. p_u_630)()
	...
	function PromptRemoteCaller(p_u_654)
		if v_u_443 then
			v_u_443:Destroy()
			v_u_443 = nil
		end
		v_u_443 = v_u_440:Clone()
		v_u_443.Parent = v_u_431.Parent
		v_u_443.Visible = true
		local v_u_655 = false
		local v_u_656 = v_u_443.MainWindow.Arguments
		local v_u_657 = v_u_443.MainWindow.ArgumentTemplate
		if p_u_654:IsA("RemoteEvent") then
			v_u_443.Title.Text = "Fire Event"
			v_u_443.MainWindow.Ok.Text = "Fire"
			v_u_443.MainWindow.DisplayReturned.Visible = false
			v_u_443.MainWindow.Desc2.Visible = false
		end
		local v_u_658 = v_u_657:Clone()
		v_u_658.Parent = v_u_656
		v_u_658.Visible = true
		v_u_658.Type.MouseButton1Down:connect(function()
			createDDown(v_u_658.Type, function(p659)
				v_u_658.Type.Text = p659
			end, "Script", "Number", "String", "Color3", "Vector3", "Vector2", "UDim2", "NumberRange")
		end)
		v_u_443.MainWindow.Ok.MouseButton1Up:connect(function()
			if v_u_443 and p_u_654.Parent ~= nil then
				local v_u_660 = {}
				for _, v661 in pairs(v_u_656:GetChildren()) do
					local v662 = v661.Value.Text
					local v663 = v661.Type.Text
					table.insert(v_u_660, v_u_653(v662, v663))
				end
				if p_u_654:IsA("RemoteFunction") then
					if v_u_655 then
						spawn(function()
							local v664 = p_u_654:InvokeServer(unpack(v_u_660))
							if v664 then
								CreateTableCaution("Remote Caller", v664)
							else
						...
						spawn(function()
							p_u_654:InvokeServer(unpack(v_u_660))
						end)
					end
				else
					p_u_654:FireServer(unpack(v_u_660))
				end
				v_u_443:Destroy()
				v_u_443 = nil
			end
		end)
		v_u_443.MainWindow.Add.MouseButton1Up:connect(function()
			if v_u_443 then
				local v_u_665 = v_u_657:Clone()
				v_u_665.Position = UDim2.new(0, 0, 0, #v_u_656:GetChildren() * 20)
				v_u_665.Parent = v_u_656
				v_u_656.CanvasSize = UDim2.new(0, 0, 0, #v_u_656:GetChildren() * 20)
				v_u_665.Visible = true
				v_u_665.Type.MouseButton1Down:connect(function()
					createDDown(v_u_665.Type, function(p666)
						v_u_665.Type.Text = p666
					end, "Script", "Number", "String", "Color3", "Vector3", "Vector2", "UDim2", "NumberRange")
				end)
			end
		end)
		v_u_443.MainWindow.Subtract.MouseButton1Up:connect(function()
			if v_u_443 and 1 < #v_u_656:GetChildren() then
				v_u_656:GetChildren()[#v_u_656:GetChildren()]:Destroy()
				v_u_656.CanvasSize = UDim2.new(0, 0, 0, #v_u_656:GetChildren() * 20)
			end
		end)
		v_u_443.MainWindow.Cancel.MouseButton1Up:connect(function()
			if v_u_443 then
				v_u_443:Destroy()
				v_u_443 = nil
			end
		end)
		v_u_443.MainWindow.DisplayReturned.MouseButton1Up:connect(function()
			if v_u_655 then
				v_u_655 = false
				v_u_443.MainWindow.DisplayReturned.enabled.Visible = false
			else
				v_u_655 = true
				v_u_443.MainWindow.DisplayReturned.enabled.Visible = true
			end
		end)
	end
	function PromptSaveInstance(p_u_667)
		if SaveInstance or _G.SaveInstance then
			if v_u_442 then
				v_u_442:Destroy()
				v_u_442 = nil
				if v_u_431.Parent:FindFirstChild("SaveInstanceOverwriteCaution") then
					v_u_431.Parent.SaveInstanceOverwriteCaution:Destroy()
				end
			end
			v_u_442 = v_u_436:Clone()
			v_u_442.Parent = v_u_431.Parent
			v_u_442.Visible = true
			local v_u_668 = v_u_442.MainWindow.FileName
			local v_u_669 = true
			local v_u_670 = false
			v_u_442.MainWindow.Save.MouseButton1Up:connect(function()
				if readfile and getelysianpath then
					if readfile(getelysianpath() .. v_u_668.Text .. ".rbxmx") then
						if not v_u_670 then
							v_u_670 = true
							local v_u_671 = v_u_437:Clone()
							v_u_671.Name = "SaveInstanceOverwriteCaution"
							v_u_671.MainWindow.Desc.Text = "The file, "
								.. v_u_668.Text
								.. ".rbxmx, already exists. Overwrite?"
							v_u_671.Parent = v_u_431.Parent
							v_u_671.Visible = true
							v_u_671.MainWindow.Yes.MouseButton1Up:connect(function()
								ypcall(function()
									SaveInstance(p_u_667, v_u_668.Text .. ".rbxmx", not v_u_669)
								end)
								v_u_670 = false
								v_u_671:Destroy()
								if v_u_442 then
							...
							v_u_671.MainWindow.No.MouseButton1Up:connect(function()
								v_u_670 = false
								v_u_671:Destroy()
							end)
							return
					...
					ypcall(function()
						if SaveInstance then
							...
							_G.SaveInstance(p_u_667, v_u_668.Text, not v_u_669)
						end
					end)
					if v_u_442 then
						v_u_442:Destroy()
			...
			v_u_442.MainWindow.Cancel.MouseButton1Up:connect(function()
				if v_u_442 then
					v_u_442:Destroy()
					v_u_442 = nil
					if v_u_431.Parent:FindFirstChild("SaveInstanceOverwriteCaution") then
			...
			v_u_442.MainWindow.SaveObjects.MouseButton1Up:connect(function()
				if v_u_669 then
					v_u_669 = false
					v_u_442.MainWindow.SaveObjects.enabled.Visible = false
				else
					v_u_669 = true
					v_u_442.MainWindow.SaveObjects.enabled.Visible = true
				end
			end)
		else
			CreateCaution(
				"SaveInstance Missing",
	...
	function DestroyRightClick()
		...
		if v_u_463 and v_u_463.Visible then
			v_u_463.Visible = false
		end
	end
	function rightClickMenu(_)
		local v672 = game.Players.LocalPlayer:GetMouse()
		v_u_462 = CreateRightClickMenu(
			{
				"Cut",
				"Copy",
				"Paste Into",
			...
			function(p673)
				if p673 == "Cut" then
					if v_u_260.Modifiable then
						v_u_552 = {}
						local v674 = v_u_586.List
						local v675 = {}
						for v676 = 1, #v674 do
							local v677 = v674[v676]:Clone()
							if v677 then
								table.insert(v_u_552, v677)
								local v678 = v674[v676]
								table.insert(v675, v678)
							end
						end
						for v679 = 1, #v675 do
							pcall(v_u_554, v675[v679])
						end
						updateActions()
					end
				elseif p673 == "Copy" then
					if v_u_260.Modifiable then
						v_u_552 = {}
						local v680 = v_u_586.List
						for v681 = 1, #v680 do
							local v682 = v680[v681]
							table.insert(v_u_552, v682:Clone())
						end
						updateActions()
					end
				elseif p673 == "Paste Into" then
					if v_u_260.Modifiable then
						local v683 = v_u_586.List[1] or workspace
						for v684 = 1, #v_u_552 do
							v_u_552[v684]:Clone().Parent = v683
						end
					end
				elseif p673 == "Duplicate" then
					if v_u_260.Modifiable then
						local v685 = v_u_586:Get()
						for v686 = 1, #v685 do
							v685[v686]:Clone().Parent = v_u_586.List[1].Parent or workspace
						end
					end
				elseif p673 == "Delete" then
					if v_u_260.Modifiable then
						local v687 = v_u_586:Get()
						for v688 = 1, #v687 do
							pcall(v_u_554, v687[v688])
						end
						v_u_586:Set({})
					end
				elseif p673 == "Group" then
					if v_u_260.Modifiable then
						local v689 = Instance.new("Model")
						local v690 = v_u_586:Get()
						v689.Parent = v_u_586.List[1].Parent or workspace
						for v691 = 1, #v690 do
							v690[v691].Parent = v689
						end
						v_u_586:Set({})
					end
				else
					if p673 == "Ungroup" then
						if not v_u_260.Modifiable then
							return
						end
						local v692 = {}
						local v693 = v_u_586:Get()
						for v694 = 1, #v693 do
							if v693[v694]:IsA("Model") then
								for _, v695 in pairs(v693[v694]:GetChildren()) do
									v695.Parent = v693[v694].Parent or workspace
									table.insert(v692, v695)
								end
								pcall(v_u_554, v693[v694])
							end
						end
						v_u_586:Set({})
						if v_u_432:Invoke("SelectUngrouped") then
							for _, v696 in pairs(v692) do
								v_u_586:Add(v696)
							end
							return
						end
					else
						if p673 == "Select Children" then
							if v_u_260.Modifiable then
								local v697 = v_u_586:Get()
								v_u_586:Set({})
								v_u_586:StopUpdates()
								for v698 = 1, #v697 do
									for _, v699 in pairs(v697[v698]:GetChildren()) do
										v_u_586:Add(v699)
									end
								end
								v_u_586:ResumeUpdates()
							end
						end
						if p673 == "Teleport To" then
							if v_u_260.Modifiable then
								local v_u_700 = v_u_586:Get()
								for v_u_701 = 1, #v_u_700 do
									if v_u_700[v_u_701]:IsA("BasePart") then
										pcall(function()
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
												v_u_700[v_u_701].CFrame
										end)
										return
									end
								end
						...
						if p673 == "Insert Part" then
							if v_u_260.Modifiable then
								local v_u_702 = {}
								local v_u_703 = v_u_586:Get()
								for v_u_704 = 1, #v_u_703 do
									pcall(function()
										local v705 = Instance.new("Part")
										v705.Parent = v_u_703[v_u_704]
										v705.CFrame = CFrame.new(game.Players.LocalPlayer.Character.Head.Position)
											+ Vector3.new(0, 3, 0)
										table.insert(v_u_702, v705)
									end)
								end
							end
						end
						if p673 == "Save Instance" then
							if not v_u_260.Modifiable then
								return
							end
							local v_u_706 = v_u_586:Get()
							if #v_u_706 == 1 then
								v_u_706[1].Archivable = true
								ypcall(function()
									PromptSaveInstance(v_u_706[1]:Clone())
								end)
								return
							end
							if 1 < #v_u_706 then
								local v_u_707 = Instance.new("Model")
								v_u_707.Name = "SavedInstances"
								for v_u_708 = 1, #v_u_706 do
									ypcall(function()
										v_u_706[v_u_708].Archivable = true
										v_u_706[v_u_708]:Clone().Parent = v_u_707
									end)
								end
								PromptSaveInstance(v_u_707)
								return
							end
						else
							if p673 == "Call Remote" then
								if v_u_260.Modifiable then
									local v709 = v_u_586:Get()
									for v710 = 1, #v709 do
										if v709[v710]:IsA("RemoteFunction") or v709[v710]:IsA("RemoteEvent") then
											PromptRemoteCaller(v709[v710])
											return
										end
									end
								end
							end
							if p673 == "View Script" then
								if not v_u_260.Modifiable then
									return
								end
								local v711 = v_u_586:Get()
								for v712 = 1, #v711 do
									if v711[v712]:IsA("LocalScript") or v711[v712]:IsA("ModuleScript") then
										v_u_441:Fire(v711[v712])
									end
								end
							end
						end
		...
		v_u_462.Parent = v_u_431.Parent
		v_u_462.Position = UDim2.new(0, v672.X, 0, v672.Y)
		if
			v_u_462.AbsolutePosition.X + v_u_462.AbsoluteSize.X
			> v_u_431.AbsolutePosition.X + v_u_431.AbsoluteSize.X
		then
			v_u_462.Position =
				UDim2.new(0, v_u_431.AbsolutePosition.X + v_u_431.AbsoluteSize.X - v_u_462.AbsoluteSize.X, 0, v672.Y)
		end
	end
	local function v_u_713() end
	local function v_u_714() end
	local v_u_715 = {}
	local v_u_716 = {}
	local v_u_717 = Create(
		"ImageButton",
		{
			["Name"] = "MouseDrag",
			["Position"] = UDim2.new(-0.25, 0, -0.25, 0),
	...
	local function v_u_732(p_u_718, p_u_719, p720)
		local v_u_721 = nil
		conDrag = v_u_717.MouseMoved:connect(function(p722, p723)
			local v724 = Vector2.new(p722, p723) - v_u_451.AbsolutePosition
			local v725 = v_u_451.AbsoluteSize
			if v724.x >= 0 and v724.x <= v725.x and v724.y >= 0 and v724.y <= v725.y then
				local v726 = v724.y / 19
				local v727 = math.ceil(v726) + v_u_452.ScrollIndex
				local v728
				if v727 < p_u_718 and v727 then
					v728 = v727
				else
					v728 = p_u_718
				end
				local v729
				if p_u_718 < v727 and v727 then
					v729 = v727
				else
					v729 = p_u_718
				end
				for v730 = v728, v729 do
					local v731 = v_u_559[v730]
					if v731 then
						if p_u_719 then
							v_u_586:Add(v731.Object)
						else
							v_u_586:Remove(v731.Object)
						end
					end
				end
				p_u_718 = v727
		...
		v_u_714 = function()
			...
			conDrag:disconnect()
			v_u_721:disconnect()
			v_u_714 = function() end
		end
		v_u_721 = v_u_717[p720]:connect(v_u_714)
		v_u_717.Parent = GetScreen(v_u_451)
	end
	local function v_u_759(p_u_733, p_u_734, p_u_735, p_u_736)
		local v_u_737 = nil
		local v_u_738 = nil
		local v_u_739 = nil
		local v_u_740 = false
		local v_u_741 = Create(
			"Frame",
			{
				["Transparency"] = 1,
				["Visible"] = false,
		...
		SetZIndex(v_u_741, 9)
		conDrag = v_u_717.MouseMoved:connect(function(p742, p743)
			local v744 = Vector2.new(p742, p743)
			if v_u_740 then
				local v745 = v744 - v_u_451.AbsolutePosition
				local v746 = v_u_451.AbsoluteSize
				v_u_739 = nil
				v_u_741.Visible = false
				if 0 <= v745.x and v745.x <= v746.x and 0 <= v745.y and v745.y <= v746.y + 36 then
					local v747 = v745.y / 19 - 2
					local v748 = math.ceil(v747)
					local v749 = v_u_559[v748 + v_u_452.ScrollIndex]
					if v749 and v749.Object ~= p_u_733 and not p_u_733:IsAncestorOf(v749.Object) then
						v_u_739 = v748
						local v750 = v_u_715[v748]
						if v750 then
							v_u_741.Visible = true
							v_u_741.Position = UDim2.new(0, 1, 0, v750.AbsolutePosition.y - v_u_451.AbsolutePosition.y)
							v_u_741.Size = UDim2.new(0, v746.x - 4, 0, v750.AbsoluteSize.y)
						end
					end
				end
				p_u_734.Position = UDim2.new(0, v744.x + p_u_736.x, 0, v744.y + p_u_736.y)
			elseif 8 < (p_u_735 - v744).magnitude then
				v_u_740 = true
				SetZIndex(p_u_734, 9)
				p_u_734.IndentFrame.Transparency = 0.25
				p_u_734.IndentFrame.EntryText.TextColor3 = v_u_267.TextSelected
				p_u_734.Position = UDim2.new(0, v744.x + p_u_736.x, 0, v744.y + p_u_736.y)
				p_u_734.Parent = GetScreen(v_u_451)
				v_u_741.Parent = v_u_451
			end
		end)
		v_u_713 = function()
			v_u_717.Parent = nil
			...
			p_u_734:Destroy()
			v_u_741:Destroy()
			v_u_713 = function() end
		end
		local v_u_751 = v_u_586.Selected[p_u_733]
		if not v_u_751 and v_u_260.Selectable then
			v_u_586:Set({ p_u_733 })
		end
		v_u_737 = v_u_717.MouseButton1Up:connect(function()
			v_u_713()
			if v_u_740 then
				local v752 = v_u_739 and v_u_559[v_u_739 + v_u_452.ScrollIndex]
				if v752 then
					v752.Expanded = true
					local v753 = v752.Object
					local function v756(p754, p755)
						p754.Parent = p755
					end
					if v_u_260.Selectable then
						local v757 = v_u_586.List
						for v758 = 1, #v757 do
							pcall(v756, v757[v758], v753)
						end
					else
						pcall(v756, p_u_733, v753)
					end
				end
			elseif v_u_751 and v_u_260.Selectable then
				v_u_586:Set({})
			end
		end)
		v_u_738 = v_u_717.MouseButton2Down:connect(function()
			v_u_713()
		end)
		v_u_717.Parent = GetScreen(v_u_451)
	end
	local v_u_760 = Create(
		"ImageButton",
		{
			["Name"] = "Entry",
			["Transparency"] = 1,
			...
			Create(
				"Frame",
				{
					["Name"] = "IndentFrame",
					["BackgroundTransparency"] = 1,
					["BackgroundColor3"] = v_u_267.Selected,
					["BorderColor3"] = v_u_267.BorderSelected,
					["Position"] = UDim2.new(0, 0, 0, 0),
					["Size"] = UDim2.new(1, 0, 1, 0),
					Create(
						v_u_304("ImageButton", 0),
						{
							["Name"] = "Expand",
							["AutoButtonColor"] = false,
	...
	function v_u_452.UpdateCallback(p_u_761)
		for v_u_762 = 1, p_u_761.VisibleSpace do
			local v763 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
			if v763 then
				local v764 = v_u_715[v_u_762]
				if not v764 then
					local v_u_765 = Create(
						v_u_760:Clone(),
						{
							["Position"] = UDim2.new(0, 2, 0, 19 * (v_u_762 - 1) + 2),
							["Size"] = UDim2.new(0, v_u_561, 0, 18),
							["ZIndex"] = v_u_451.ZIndex,
						}
					)
					v_u_715[v_u_762] = v_u_765
					local v_u_766 = v_u_765.IndentFrame.Expand
					v_u_766.MouseEnter:connect(function()
						local v767 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
						if 0 < #v767 then
							if v767.Expanded then
								v_u_304(v_u_766, 180)
								return
							end
							v_u_304(v_u_766, 179)
					...
					v_u_766.MouseLeave:connect(function()
						local v768 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
						if 0 < #v768 then
							if v768.Expanded then
								v_u_304(v_u_766, 166)
								return
							end
							v_u_304(v_u_766, 165)
					...
					v_u_766.MouseButton1Down:connect(function()
						local v769 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
						if 0 < #v769 then
							v769.Expanded = not v769.Expanded
							if v769.Object == v_u_431.Parent and v769.Expanded then
								CreateCaution(
									"Warning",
					...
					v_u_765.MouseButton1Down:connect(function(p770, p771)
						local v772 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
						DestroyRightClick()
						if v_u_434:Invoke() then
							v_u_435:Fire(v772.Object)
							return
						else
							if not v_u_263 then
								v_u_444 = v_u_762 + p_u_761.ScrollIndex
							end
							if v_u_263 and not filteringWorkspace() then
								if v_u_444 then
									if 0 < v_u_762 + p_u_761.ScrollIndex - v_u_444 then
										v_u_586:StopUpdates()
										for v773 = 1, v_u_762 + p_u_761.ScrollIndex - v_u_444 do
											local v774 = v_u_559[v_u_444 + v773]
											if v774 then
												v_u_586:Add(v774.Object)
											end
										end
										v_u_586:ResumeUpdates()
										return
									...
									v_u_586:StopUpdates()
									for v775 = v_u_762 + p_u_761.ScrollIndex - v_u_444, 1 do
										local v776 = v_u_559[v_u_444 + v775]
										if v776 then
											v_u_586:Add(v776.Object)
										end
									end
									v_u_586:ResumeUpdates()
								end
								return
							elseif v_u_262 then
								if v_u_586.Selected[v772.Object] then
									v_u_586:Remove(v772.Object)
								else
									v_u_586:Add(v772.Object)
								end
							elseif v_u_260.Modifiable then
								local v777 = Vector2.new(p770, p771)
								v_u_759(v772.Object, v_u_765:Clone(), v777, v_u_765.AbsolutePosition - v777)
							elseif v_u_260.Selectable then
								if v_u_586.Selected[v772.Object] then
									v_u_586:Set({})
								else
									v_u_586:Set({ v772.Object })
								end
								v_u_732(v_u_762 + p_u_761.ScrollIndex, true, "MouseButton1Up")
							end
						end
					end)
					v_u_765.MouseButton2Down:connect(function()
						if v_u_260.Selectable then
							DestroyRightClick()
							curSelect = v_u_765
							local v778 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
							if v_u_434:Invoke() then
								v_u_435:Fire(v778.Object)
							elseif not v_u_586.Selected[v778.Object] then
								v_u_586:Set({ v778.Object })
							end
						else
							return
						end
					end)
					v_u_765.MouseButton2Up:connect(function()
						if v_u_260.Selectable then
							local v779 = v_u_559[v_u_762 + p_u_761.ScrollIndex]
							if checkMouseInGui(curSelect) then
								rightClickMenu(v779.Object)
							end
						end
					end)
					v_u_765.Parent = v_u_451
					v764 = v_u_765
				end
				v764.Visible = true
				local v_u_780 = v763.Object
				if #v763 == 0 then
					v764.IndentFrame.Expand.Visible = false
				elseif v763.Expanded then
					v_u_304(v764.IndentFrame.Expand, 166)
					v764.IndentFrame.Expand.Visible = true
				else
					v_u_304(v764.IndentFrame.Expand, 165)
					v764.IndentFrame.Expand.Visible = true
				end
				v_u_304(v764.IndentFrame.ExplorerIcon, v_u_268[v_u_780.ClassName] or 0)
				local v781 = v763.Depth * 19
				v764.IndentFrame.Position = UDim2.new(0, v781, 0, 0)
				v764.IndentFrame.Size = UDim2.new(1, -v781, 1, 0)
				if v_u_716[v764] then
					v_u_716[v764]:disconnect()
				end
				local v_u_782 = v764.IndentFrame.EntryText
				v_u_782.Text = v_u_780.Name
				v_u_716[v764] = v763.Object.Changed:connect(function(p783)
					if p783 == "Name" then
						v_u_782.Text = v_u_780.Name
					end
				end)
				v764.IndentFrame.Transparency = v763.Selected and 0 or 1
				v_u_782.TextColor3 = v_u_267[v763.Selected and "TextSelected" or "Text"]
				v764.Size = UDim2.new(0, v_u_561, 0, 18)
			elseif v_u_715[v_u_762] then
				v_u_715[v_u_762].Visible = false
			end
		end
		for v784 = p_u_761.VisibleSpace + 1, p_u_761.TotalSpace do
			local v785 = v_u_715[v784]
			if v785 then
				v_u_715[v784] = nil
				v785:Destroy()
			end
	...
	function v_u_453.UpdateCallback(_)
		for v786 = 1, v_u_452.VisibleSpace do
			if v_u_559[v786 + v_u_452.ScrollIndex] then
				local v787 = v_u_715[v786]
				if v787 then
					v787.Position = UDim2.new(0, 2 - v_u_453.ScrollIndex, 0, 19 * (v786 - 1) + 2)
				end
			end
		end
	end
	Connect(v_u_451.Changed, function(p788)
		if p788 == "AbsoluteSize" then
			v_u_574()
		end
	end)
	v_u_431.MouseWheelForward:connect(function()
		if 6 < v_u_452.VisibleSpace - 1 then
			v_u_452:ScrollTo(v_u_452.ScrollIndex - 6)
		else
			v_u_452:ScrollTo(v_u_452.ScrollIndex - v_u_452.VisibleSpace)
		end
	end)
	v_u_431.MouseWheelBackward:connect(function()
		if 6 < v_u_452.VisibleSpace - 1 then
			v_u_452:ScrollTo(v_u_452.ScrollIndex + 6)
		else
			v_u_452:ScrollTo(v_u_452.ScrollIndex + v_u_452.VisibleSpace)
	...
	local function v_u_794(p789, p790, p791)
		for v792 = #p789, p790, -1 do
			local v793 = p789[v792]
			v793.Index = v792 + 1
			p789[v792 + 1] = v793
		end
		p791.Index = p790
	...
	local function v_u_800(p795, p796)
		local v797 = p795[p796]
		for v798 = p796 + 1, #p795 do
			local v799 = p795[v798]
			v799.Index = v798 - 1
			p795[v798 - 1] = v799
		end
		p795[#p795] = nil
	...
	local v_u_804 = {}
	local function v_u_808(p805)
		local v806 = p805.Parent
		local v807 = true
		while v806 and v807 do
			v807 = v807 and v806.Expanded
			v806 = v806.Parent
		end
		return v807
	end
	local function v_u_813(p809)
		local v810 = v_u_560[p809]
		if v810 then
			local v811 = v_u_808(v810)
			v_u_586:Remove(p809, true)
			local v812 = v810.Parent
			v_u_800(v812, v810.Index)
			v_u_560[p809] = nil
			v_u_804[p809]:disconnect()
			v_u_804[p809] = nil
			if v811 then
				v_u_577()
			elseif v_u_808(v812) then
				v_u_579()
			end
		else
			return
	...
	local function v_u_823(p814, p815)
		local v816 = v_u_560[p814]
		if v816 then
			local v817 = v_u_560[p815]
			if v817 then
				local v818 = v_u_808(v816)
				v_u_800(v816.Parent, v816.Index)
				v816.Parent = v817
				v816.Depth = v_u_803(p814)
				local function v_u_822(p819, p820)
					for v821 = 1, #p819 do
						p819[v821].Depth = p820
						v_u_822(p819[v821], p820 + 1)
					end
				end
				v_u_822(v816, v816.Depth + 1)
				v_u_794(v817, #v817 + 1, v816)
				if v818 or v_u_808(v816) then
					v_u_577()
				elseif v_u_808(v816.Parent) then
					v_u_579()
				end
			else
				return
	...
	local function v_u_825(p824)
		return p824.AncestryChanged
	end
	local function v_u_832(p_u_826, p827)
		if script and not pcall(v_u_825, p_u_826) then
			return
		else
			local v828 = v_u_560[p_u_826.Parent]
			if v828 then
				local v829 = {
					["Object"] = p_u_826,
					["Parent"] = v828,
					...
					["Expanded"] = false,
					["Selected"] = false,
					["Depth"] = v_u_803(p_u_826),
				}
				v_u_804[p_u_826] = Connect(p_u_826.AncestryChanged, function(p830, p831)
					if p830 == p_u_826 then
						if p831 == nil then
							v_u_813(p830)
							return
						end
				...
				v_u_560[p_u_826] = v829
				v_u_794(v828, #v828 + 1, v829)
				if not p827 then
					if v_u_808(v829) then
						v_u_577()
						return
					end
					if v_u_808(v829.Parent) then
						v_u_579()
					end
				end
			end
	...
	local function v836()
		local v_u_833 = nil
		local v834, _ = ypcall(function()
			v_u_833 = game:GetObjects("rbxasset://DexStorage.rbxm")[1]
		end)
		if v834 and v_u_833 then
			for _, v_u_835 in pairs(v_u_833:GetChildren()) do
				ypcall(function()
					v_u_835.Parent = v_u_446
				end)
			end
		end
	...
	local v_u_837 = false
	local v_u_838 = {}
	local function v_u_839()
		if not v_u_837 then
			v_u_837 = true
			wait()
			pcall(function()
				saveinstance("content//DexStorage.rbxm", v_u_446)
			end)
			updateDexStorageListeners()
			v_u_837 = false
		end
	...
	function updateDexStorageListeners()
		for _, v840 in pairs(v_u_838) do
			v840:Disconnect()
		end
		v_u_838 = {}
		for _, v_u_841 in pairs(v_u_446:GetChildren()) do
			pcall(function()
				local v842 = v_u_841.Changed:connect(v_u_839)
				table.insert(v_u_838, v842)
			end)
		end
	end
	v_u_560[workspace.Parent] = { ["Object"] = workspace.Parent, ["Parent"] = nil, ["Index"] = 0, ["Expanded"] = true }
	if v_u_447 then
		v_u_560[v_u_445] = { ["Object"] = v_u_445, ["Parent"] = nil, ["Index"] = 0, ["Expanded"] = true }
	end
	if v_u_450 then
		v_u_560[v_u_448] = { ["Object"] = v_u_448, ["Parent"] = nil, ["Index"] = 0, ["Expanded"] = true }
	end
	Connect(game.DescendantAdded, v_u_832)
	Connect(game.DescendantRemoving, v_u_813)
	if v_u_447 then
		v836()
		Connect(v_u_445.DescendantAdded, v_u_832)
		Connect(v_u_445.DescendantRemoving, v_u_813)
		Connect(v_u_445.DescendantAdded, v_u_839)
		Connect(v_u_445.DescendantRemoving, v_u_839)
	end
	if v_u_450 then
		Connect(v_u_448.DescendantAdded, v_u_832)
		Connect(v_u_448.DescendantRemoving, v_u_813)
		local v_u_843 = get_nil_instances()
		spawn(function()
			while wait() do
				if #v_u_843 ~= #get_nil_instances() then
					v_u_843 = get_nil_instances()
					for _, v_u_844 in pairs(get_nil_instances()) do
						if v_u_844 ~= v_u_448 and v_u_844 ~= v_u_445 then
							pcall(function()
								v_u_844.Parent = v_u_449
							end)
						end
					end
				end
	...
	local function v_u_846(p845)
		return p845:GetChildren()
	end
	local function v_u_851(p847)
		local v848, v849 = pcall(v_u_846, p847)
		if v848 then
			for v850 = 1, #v849 do
				v_u_832(v849[v850], true)
				v_u_851(v849[v850])
			end
		end
	end
	v_u_851(workspace.Parent)
	if v_u_447 then
		v_u_851(v_u_445)
	end
	if v_u_450 then
	...
	local v852 = v_u_451.AbsoluteSize.y / 19
	v_u_452.VisibleSpace = math.ceil(v852)
	v_u_577()
	local v_u_853 = {}
	local v_u_854 = 1
	local function v862(p_u_855, p_u_856, p857, _, p858)
		local v_u_859 = false
		local v_u_860 = Create(
			v_u_304("ImageButton", p_u_855),
			{
				["Name"] = p857 .. "Button",
				["Visible"] = v_u_260.Modifiable and v_u_260.Selectable,
				["Position"] = UDim2.new(1, -18 * v_u_854 + 2, 0.25, -8),
				["Size"] = UDim2.new(0, 16, 0, 16),
				["Parent"] = v_u_454,
			}
		)
		...
		v_u_860.MouseEnter:connect(function()
			if v_u_859 then
				v_u_860.BackgroundTransparency = 0.9
			end
		end)
		v_u_860.MouseLeave:connect(function()
			v_u_860.BackgroundTransparency = 1
		end)
		v_u_854 = v_u_854 + 1
		v_u_853[#v_u_853 + 1] = { ["Obj"] = v_u_860, ["Cond"] = p858 }
		v_u_562[#v_u_853 + 1] = {
			["Obj"] = v_u_860,
			["Cond"] = p858,
			["Toggle"] = function(p861)
				if p861 then
					v_u_859 = true
					v_u_304(v_u_860, p_u_856)
				else
					v_u_859 = false
					v_u_304(v_u_860, p_u_855)
				end
			end,
		}
		return v_u_860
	end
	local function v_u_864(p863)
		p863.Parent = nil
	end
	v862(190, 190, "Options", true, function()
		return true
	end).MouseButton1Click:connect(function() end)
	v862(163, 177, "Delete", true, function()
		return 0 < #v_u_586:Get()
	end).MouseButton1Click:connect(function()
		if v_u_260.Modifiable then
			local v865 = v_u_586:Get()
			for v866 = 1, #v865 do
				pcall(v_u_864, v865[v866])
			end
			v_u_586:Set({})
		end
	end)
	v862(162, 176, "Paste", true, function()
		local v867
		if 0 < #v_u_586:Get() then
			v867 = 0 < #v_u_552
		else
			v867 = false
		end
		...
		if v_u_260.Modifiable then
			local v868 = v_u_586.List[1] or workspace
			for v869 = 1, #v_u_552 do
				v_u_552[v869]:Clone().Parent = v868
			end
		end
	end)
	v862(161, 175, "Copy", true, function()
		return 0 < #v_u_586:Get()
	end).MouseButton1Click:connect(function()
		if v_u_260.Modifiable then
			v_u_552 = {}
			local v870 = v_u_586.List
			for v871 = 1, #v870 do
				local v872 = v870[v871]
				table.insert(v_u_552, v872:Clone())
			end
			updateActions()
		end
	end)
	v862(160, 174, "Cut", true, function()
		return 0 < #v_u_586:Get()
	end).MouseButton1Click:connect(function()
		if v_u_260.Modifiable then
			v_u_552 = {}
			local v873 = v_u_586.List
			local v874 = {}
			for v875 = 1, #v873 do
				local v876 = v873[v875]:Clone()
				if v876 then
					table.insert(v_u_552, v876)
					local v877 = v873[v875]
					table.insert(v874, v877)
				end
			end
			for v878 = 1, #v874 do
				pcall(v_u_864, v874[v878])
			end
			updateActions()
		end
	end)
	v862(188, 188, "Freeze", true, function()
		return true
	end)
	v862(184, 187, "Star", true, function()
		return 0 < #v_u_586:Get()
	end)
	v862(189, 189, "Starred", true, function()
		return true
	end)
	local v_u_883 = {
		["Modifiable"] = function(p879)
			for v880 = 1, #v_u_853 do
				v_u_853[v880].Obj.Visible = p879 and v_u_260.Selectable
			end
			v_u_713()
		end,
		["Selectable"] = function(p881)
			for v882 = 1, #v_u_853 do
				v_u_853[v882].Obj.Visible = p881 and v_u_260.Modifiable
			end
			v_u_714()
			v_u_586:Set({})
		end,
	}
	local v884 = v_u_431:FindFirstChild("SetOption")
	if not v884 then
		v884 = Create("BindableFunction", { ["Name"] = "SetOption" })
		v884.Parent = v_u_431
	end
	function v884.OnInvoke(p885, p886)
		if v_u_883[p885] then
			v_u_260[p885] = p886
			v_u_883[p885](p886)
		end
	end
	local v887 = v_u_431:FindFirstChild("GetOption")
	if not v887 then
		v887 = Create("BindableFunction", { ["Name"] = "GetOption" })
		v887.Parent = v_u_431
	end
	function v887.OnInvoke(p888)
		if p888 then
			return v_u_260[p888]
		end
		local v889 = {}
		for v890, v891 in pairs(v_u_260) do
			v889[v890] = v891
		end
		return v889
	end
	...
	v261.InputBegan:connect(function(p892)
		if p892.KeyCode == Enum.KeyCode.LeftControl then
			v_u_262 = true
		end
		if p892.KeyCode == Enum.KeyCode.LeftShift then
			v_u_263 = true
		end
	end)
	v261.InputEnded:connect(function(p893)
		if p893.KeyCode == Enum.KeyCode.LeftControl then
			v_u_262 = false
		end
		if p893.KeyCode == Enum.KeyCode.LeftShift then
			v_u_263 = false
		end
	end)
	while v_u_465 == nil do
		v_u_465 = v433:Invoke()
		wait()
	end
	v_u_455.Changed:connect(function(p894)
		if p894 == "Text" then
			v_u_575()
		end
	end)
	v_u_463 = CreateInsertObjectMenu(GetClasses(), "", false, function(p_u_895)
		v_u_463.Visible = false
		local v_u_896 = SelectionVar():Get()
		for v_u_897 = 1, #v_u_896 do
			pcall(function()
				Instance.new(p_u_895, v_u_896[v_u_897])
			end)
		end
		DestroyRightClick()
	end)
...
spawn(function()
	wait(0.2)
	local function v_u_899(p898)
		print(tostring(p898))
	end
	game:GetService("Teams")
	game:GetService("Workspace")
	game:GetService("Debris")
	local v900 = game:GetService("ContentProvider")
	local v_u_901 = game:GetService("Players")
	game:GetService("ReplicatedStorage")
	function httpGet(p902)
		return game:HttpGet(p902, true)
	end
	if script:FindFirstChild("RawApiJson") then
		local _ = script.RawApiJson
	end
	...
	function getCurrentApiJson()
		...
		if readfile and getelysianpath and readfile(getelysianpath() .. "Xpl0rerApi.txt") then
			v_u_899("Api found in folder!")
			return readfile(getelysianpath() .. "Xpl0rerApi.txt")
		end
		local v904, v905 = pcall(function()
			v_u_903 = httpGet("http://anaminus.github.io/rbx/json/api/latest.json")
			v_u_899("Fetched json successfully")
		end)
		if v904 then
			v_u_899("Returning json")
			return v_u_903
		end
		v_u_899("Error fetching json: " .. tostring(v905))
		v_u_899("Falling back to local copy")
		return getLocalApiJson()
	end
	function splitStringIntoChunks(p906)
		local v907 = {}
		local v908 = string.len(p906) / 100000
		for v909 = 1, math.ceil(v908) do
			local v910 = p906:sub((v909 - 1) * 100000 + 1, v909 * 100000)
			table.insert(v907, v910)
		end
		return v907
	end
	local v911 = getCurrentApiJson()
	local v_u_912 = splitStringIntoChunks(v911)
	function getRbxApi()
		local v_u_913 = game:GetService("HttpService")
		game:GetService("ServerStorage")
		game:GetService("ReplicatedStorage")
		local function v_u_915(p914)
			if v_u_912[p914] then
				return v_u_912[p914], #v_u_912
			end
			v_u_899("Bad index for GetApiJson")
			return nil
		end
		local v922 = (function(p916)
			return v_u_913:JSONDecode(p916)
		end)(((function()
			local v917 = {}
			local v918, v919 = v_u_915(1)
			table.insert(v917, v918)
			for v920 = 2, v919 do
				local v921 = v_u_915(v920)
				table.insert(v917, v921)
			end
			return table.concat(v917)
		end)()))
		local v_u_923 = {}
		local v_u_924 = {}
		local function v_u_929(p925, p_u_926)
			table.sort(p925, function(p927, p928)
				return p927[p_u_926] < p928[p_u_926]
			end)
		end
		local function v931(p930)
			return v_u_924[p930] ~= nil
		end
		local function v936(p932)
			local v933 = v_u_923[p932]
			local v934 = {}
			if not v933 then
				return v934
			end
			while v933 do
				for _, v935 in pairs(v933.Properties) do
					table.insert(v934, v935)
				end
				v933 = v_u_923[v933.Superclass]
			end
			v_u_929(v934, "Name")
			return v934
		end
		for _, v937 in pairs(v922) do
			local v938 = v937.type
			if v938 == "Class" then
				v_u_923[v937.Name] = v937
				v937.Properties = {}
				v937.Functions = {}
				v937.YieldFunctions = {}
				v937.Events = {}
				v937.Callbacks = {}
			elseif v938 == "Property" then
				local v939 = v_u_923[v937.Class].Properties
				table.insert(v939, v937)
			elseif v938 == "Function" then
				local v940 = v_u_923[v937.Class].Functions
				table.insert(v940, v937)
			elseif v938 == "YieldFunction" then
				local v941 = v_u_923[v937.Class].YieldFunctions
				table.insert(v941, v937)
			elseif v938 == "Event" then
				local v942 = v_u_923[v937.Class].Events
				table.insert(v942, v937)
			elseif v938 == "Callback" then
				local v943 = v_u_923[v937.Class].Callbacks
				table.insert(v943, v937)
			elseif v938 == "Enum" then
				v_u_924[v937.Name] = v937
				v937.EnumItems = {}
			elseif v938 == "EnumItem" then
				v_u_924[v937.Enum].EnumItems[v937.Name] = v937
			end
		end
		return { ["Classes"] = v_u_923, ["Enums"] = v_u_924, ["GetProperties"] = v936, ["IsEnum"] = v931 }
	end
	local v_u_944 = { ["CanEdit"] = true }
	local v_u_945 = getRbxApi()
	local function v949(p946, p947, p948)
		return Color3.new(p946 / 255, p947 / 255, p948 / 255)
	end
	local v_u_950 =
		{ ["Font"] = Enum.Font.Arial, ["Margin"] = 5, ["Black"] = v949(0, 0, 0), ["White"] = v949(255, 255, 255) }
	local v_u_951 = {
		["Font"] = v_u_950.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["TextColor"] = v_u_950.Black,
		["TextColorOver"] = v_u_950.White,
		["TextLockedColor"] = v949(120, 120, 120),
		["Height"] = 24,
		["BorderColor"] = v949(216, 216, 216),
		["BackgroundColor"] = v_u_950.White,
		["BackgroundColorAlternate"] = v949(246, 246, 246),
		["BackgroundColorMouseover"] = v949(211, 224, 244),
		["TitleMarginLeft"] = 15,
	}
	local v_u_952 = {
		["Font"] = v_u_950.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextColor"] = v949(0, 0, 0),
		["TextColorOver"] = v_u_950.White,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["Height"] = 16,
		["BackColor"] = v_u_950.White,
		["BackColorOver"] = v949(86, 125, 188),
		["BorderColor"] = v949(216, 216, 216),
		["BorderSizePixel"] = 2,
		["ArrowColor"] = v949(160, 160, 160),
		["ArrowColorOver"] = v_u_950.Black,
	}
	local v_u_953 = {
		["BoxSize"] = 13,
		["BorderSizePixel"] = 1,
		["BorderColor"] = v949(160, 160, 160),
		["FrameColor"] = v949(160, 160, 160),
		["Size"] = 20,
		["Padding"] = 4,
		["ColorsPerRow"] = 8,
		["OuterBorder"] = 1,
		["OuterBorderColor"] = v_u_950.Black,
	}
	wait(1)
	local v954 = v_u_164
	local v_u_955 = v954:WaitForChild("PropertiesFrame")
	local v956 = v954:WaitForChild("ExplorerPanel")
	local v_u_957 = v956.TotallyNotGetSelection
	local v958 = v956.TotallyNotSelectionChanged
	local v959 = v_u_955.GetApi
	local v960 = v_u_955.GetAwaiting
	local v961 = v_u_955.SetAwaiting
	local v_u_962 = v900.BaseUrl .. "asset/?id="
	local v_u_963 = v954:WaitForChild("SettingsPanel"):WaitForChild("GetSetting")
	local v_u_964 = v_u_955.Header.TextBox
	local v_u_965 = false
	local v_u_966 = nil
	local v_u_967 = nil
	function searchingProperties()
		return v_u_964.Text ~= "" and v_u_964.Text ~= "Search Properties"
	end
	local function v_u_969()
		local v968 = v_u_957:Invoke()
		if #v968 == 0 then
			return nil
		else
			return v968
	...
	local function v_u_972(p970, p971)
		return tonumber(string.format("%." .. (p971 or 0) .. "f", p970))
	end
	local function v_u_981(p973, p974)
		local v975 = {}
		local v976 = 1
		while true do
			local v977 = string.find(p973, p974, v976, true)
			if not v977 then
				break
			end
			local v978 = v977 - 1
			local v979 = string.sub
			table.insert(v975, v979(p973, v976, v978))
			v976 = v977 + string.len(p974)
		end
		local v980 = string.sub
		table.insert(v975, v980(p973, v976))
		return v975
	end
	local function v_u_997(p982, p983)
		if p983 == "float" then
			return tostring(v_u_972(p982, 2))
		end
		if p983 == "Content" then
			if not string.find(p982, "/asset") then
				return tostring(p982)
			end
			local v984 = string.find(p982, "=") + 1
			return string.sub(p982, v984)
		end
		if p983 == "Vector2" then
			local v985 = p982.x
			local v986 = p982.y
			return string.format("%g, %g", v985, v986)
		end
		if p983 == "Vector3" then
			local v987 = p982.x
			local v988 = p982.y
			local v989 = p982.z
			return string.format("%g, %g, %g", v987, v988, v989)
		end
		if p983 == "Color3" then
			local v990 = p982.r
			local v991 = p982.g
			local v992 = p982.b
			return string.format("%d, %d, %d", v990 * 255, v991 * 255, v992 * 255)
		end
		if p983 ~= "UDim2" then
			return tostring(p982)
		end
		local v993 = p982.X.Scale
		local v994 = p982.X.Offset
		local v995 = p982.Y.Scale
		local v996 = p982.Y.Offset
		return string.format("{%d, %d}, {%d, %d}", v993, v994, v995, v996)
	end
	local function v_u_1020(p998, p999)
		if p999 == "Vector2" then
			local v1000 = v_u_981(p998, ",")
			if #v1000 < 2 then
				return nil
			end
			local v1001 = tonumber(v1000[1]) or 0
			local v1002 = tonumber(v1000[2]) or 0
			return Vector2.new(v1001, v1002)
		end
		if p999 == "Vector3" then
			local v1003 = v_u_981(p998, ",")
			if #v1003 < 3 then
				return nil
			end
			local v1004 = tonumber(v1003[1]) or 0
			local v1005 = tonumber(v1003[2]) or 0
			local v1006 = tonumber(v1003[3]) or 0
			return Vector3.new(v1004, v1005, v1006)
		end
		if p999 == "Color3" then
			local v1007 = v_u_981(p998, ",")
			if #v1007 < 3 then
				return nil
			end
			local v1008 = tonumber(v1007[1]) or 0
			local v1009 = tonumber(v1007[2]) or 0
			local v1010 = tonumber(v1007[3]) or 0
			return Color3.new(v1008 / 255, v1009 / 255, v1010 / 255)
		end
		if p999 == "UDim2" then
			local v1011 = v_u_981(string.gsub(string.gsub(p998, "{", ""), "}", ""), ",")
			if #v1011 < 4 then
				return nil
			end
			local v1012 = tonumber(v1011[1]) or 0
			local v1013 = tonumber(v1011[2]) or 0
			local v1014 = tonumber(v1011[3]) or 0
			local v1015 = tonumber(v1011[4]) or 0
			return UDim2.new(v1012, v1013, v1014, v1015)
		end
		if p999 == "Content" then
			if tonumber(p998) ~= nil then
				p998 = v_u_962 .. p998
			end
			return p998
		end
		if p999 == "float" or p999 == "int" or p999 == "double" then
			return tonumber(p998)
		end
		if p999 == "string" then
			return p998
		end
		if p999 ~= "NumberRange" then
			return nil
		end
		local v1016 = v_u_981(p998, ",")
		if #v1016 == 1 then
			if tonumber(v1016[1]) == nil then
				return nil
			end
			local v1017 = tonumber(v1016[1]) or 0
			return NumberRange.new(v1017)
		end
		if #v1016 < 2 then
			return nil
		end
		local v1018 = tonumber(v1016[1]) or 0
		local v1019 = tonumber(v1016[2]) or 0
		return NumberRange.new(v1018, v1019)
	end
	local v_u_1021 = { ["Width"] = 13, ["Height"] = 13 }
	local v_u_1022 = { ["Image"] = "http://www.roblox.com/asset/?id=128896947", ["Height"] = 256, ["Width"] = 256 }
	local v_u_1023 =
		{ "unchecked", "checked", "unchecked_over", "checked_over", "unchecked_disabled", "checked_disabled" }
	local function v_u_1028(p1024)
		local v1025 = 0
		local v1026 = 0
		v1025 = 0
		v1026 = 0
		for _, v1027 in pairs(v_u_1023) do
			if v1027 == p1024 then
				return { v1026, v1025 }
			end
			v1026 = v1026 + v_u_1021.Height
			if v1026 + v_u_1021.Width > v_u_1022.Width then
				v1025 = v1025 + v_u_1021.Height
				v1026 = 0
			end
		end
	end
	local function v_u_1032(p1029, p1030, p1031)
		if p1029 then
			return p1030 and "checked_disabled" or p1031 and "checked_over" or "checked"
		else
			return p1030 and "unchecked_disabled" or p1031 and "unchecked_over" or "unchecked"
		end
	end
	local v_u_1033 = "http://www.roblox.com/asset/?id=" .. 418720155
	game:GetService("ContentProvider"):Preload(v_u_1033)
	local v_u_1034 = math.floor
	local function v_u_1036(p1035)
		return v_u_1034(p1035 / 14 % 14), v_u_1034(p1035 % 14)
	end
	local function v_u_1044(p1037, p1038)
		local v1039, v1040 = v_u_1036(p1038)
		local v1041 = Vector2.new(256, 256)
		local v1042
		if type(p1037) == "string" then
			v1042 = nil
		else
			v1042 = p1037
			p1037 = "Frame"
				...
				p1037,
				{
					...
					Create(
						"ImageLabel",
						{
							...
							["BackgroundTransparency"] = 1,
							["Image"] = v_u_1033,
							["Size"] = UDim2.new(v1041.x / 16, 0, v1041.y / 16, 0),
						}
					),
				}
			)
		v1043.IconMap.Position =
			UDim2.new(-v1040 - (2 * (v1040 + 1) + 1) / 16, 0, -v1039 - (2 * (v1039 + 1) + 1) / 16, 0)
		return v1043
	end
	local function v_u_1046()
		local v1045 = Instance.new("Frame")
		v1045.Size = UDim2.new(0.5, -1, 1, 0)
		v1045.BackgroundColor3 = v_u_951.BackgroundColor
		v1045.BorderColor3 = v_u_951.BorderColor
		return v1045
	end
	local function v_u_1049(p1047)
		local v1048 = Instance.new("TextLabel")
		v1048.Font = v_u_951.Font
		v1048.FontSize = v_u_951.FontSize
		v1048.TextXAlignment = v_u_951.TextXAlignment
		v1048.BackgroundTransparency = 1
		if p1047 then
			v1048.TextColor3 = v_u_951.TextLockedColor
			return v1048
		else
			v1048.TextColor3 = v_u_951.TextColor
			return v1048
		end
	end
	local function v_u_1053(p1050, p_u_1051)
		local v1052 = Instance.new("TextButton")
		v1052.Font = v_u_951.Font
		v1052.FontSize = v_u_951.FontSize
		v1052.TextXAlignment = v_u_951.TextXAlignment
		v1052.BackgroundTransparency = 1
		if p1050 then
			v1052.TextColor3 = v_u_951.TextLockedColor
			return v1052
		end
		v1052.TextColor3 = v_u_951.TextColor
		v1052.MouseButton1Click:connect(function()
			p_u_1051()
		end)
		return v1052
	end
	local function v_u_1056(p1054)
		local v1055 = Instance.new("TextButton")
		v1055.Font = v_u_951.Font
		v1055.FontSize = v_u_951.FontSize
		v1055.TextXAlignment = v_u_951.TextXAlignment
		v1055.BackgroundTransparency = 1
		if p1054 then
			v1055.TextColor3 = v_u_951.TextLockedColor
		else
			v1055.TextColor3 = v_u_951.TextColor
		end
		Create(
			v_u_1044("ImageButton", 177),
			{
				["Name"] = "Cancel",
				["Visible"] = false,
	...
	local function v_u_1059(p1057)
		if p1057 then
			return v_u_1049(p1057)
		end
		local v1058 = Instance.new("TextBox")
		if not v_u_963:Invoke("ClearProps") then
			v1058.ClearTextOnFocus = false
		end
		v1058.Font = v_u_951.Font
		v1058.FontSize = v_u_951.FontSize
		v1058.TextXAlignment = v_u_951.TextXAlignment
		v1058.BackgroundTransparency = 1
		v1058.TextColor3 = v_u_951.TextColor
		return v1058
	end
	local function v_u_1063(p_u_1060, p_u_1061)
		local v_u_1062 = Instance.new("TextButton")
		v_u_1062.Font = v_u_952.Font
		v_u_1062.FontSize = v_u_952.FontSize
		v_u_1062.TextColor3 = v_u_952.TextColor
		v_u_1062.TextXAlignment = v_u_952.TextXAlignment
		v_u_1062.BackgroundColor3 = v_u_952.BackColor
		v_u_1062.AutoButtonColor = false
		v_u_1062.BorderSizePixel = 0
		v_u_1062.Active = true
		v_u_1062.Text = p_u_1060
		v_u_1062.MouseEnter:connect(function()
			v_u_1062.TextColor3 = v_u_952.TextColorOver
			v_u_1062.BackgroundColor3 = v_u_952.BackColorOver
		end)
		v_u_1062.MouseLeave:connect(function()
			v_u_1062.TextColor3 = v_u_952.TextColor
			v_u_1062.BackgroundColor3 = v_u_952.BackColor
		end)
		v_u_1062.MouseButton1Click:connect(function()
			p_u_1061(p_u_1060)
		end)
		return v_u_1062
	end
	local function v_u_1087(p_u_1064, p1065, p1066, p_u_1067)
		local v_u_1068 = Instance.new("Frame")
		v_u_1068.Name = "DropDown"
		v_u_1068.Size = UDim2.new(1, 0, 1, 0)
		v_u_1068.BackgroundTransparency = 1
		v_u_1068.Active = true
		local v_u_1069 = nil
		local v_u_1070 = nil
		local v_u_1071 = false
		local v_u_1072 = v_u_952.BorderSizePixel
		local v_u_1073 = Instance.new("TextButton")
		v_u_1073.Font = v_u_951.Font
		v_u_1073.FontSize = v_u_951.FontSize
		v_u_1073.TextXAlignment = v_u_951.TextXAlignment
		v_u_1073.BackgroundTransparency = 1
		v_u_1073.TextColor3 = v_u_951.TextColor
		if p1066 then
			v_u_1073.TextColor3 = v_u_951.TextLockedColor
		end
		v_u_1073.Text = p1065
		v_u_1073.Size = UDim2.new(1, -2 * v_u_950.Margin, 1, 0)
		v_u_1073.Position = UDim2.new(0, v_u_950.Margin, 0, 0)
		v_u_1073.Parent = v_u_1068
		local function v_u_1076(p1074)
			if v_u_1070 then
				v_u_1070:Destroy()
			end
			local v1075 =
				Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = p1074 })
			v_u_1070 = ArrowGraphic(8, "Down", true, v1075)
			v_u_1070.Position = UDim2.new(1, -16, 0.5, -4)
			v_u_1070.Parent = v_u_1068
		end
		local function v_u_1077()
			v_u_1071 = false
			v_u_1076(v_u_952.ArrowColor)
			if v_u_1069 then
				v_u_1069:Destroy()
			end
		end
		local function v_u_1086()
			v_u_1071 = true
			v_u_1069 = Instance.new("Frame")
			v_u_1069.Size = UDim2.new(1, -2 * v_u_1072, 0, #p_u_1064 * v_u_952.Height)
			v_u_1069.Position = UDim2.new(0, v_u_1072, 0, v_u_951.Height + v_u_1072)
			v_u_1069.BackgroundTransparency = 0
			v_u_1069.BackgroundColor3 = v_u_952.BackColor
			v_u_1069.BorderColor3 = v_u_952.BorderColor
			v_u_1069.BorderSizePixel = v_u_952.BorderSizePixel
			v_u_1069.Active = true
			v_u_1069.ZIndex = 5
			v_u_1069.Parent = v_u_1068
			local v1078 = v_u_1069.Parent.Parent.Parent.Parent.Size.Y.Offset
			local v1079 = v_u_1069.Parent.Parent.Parent.Position.Y.Offset + v_u_1069.Size.Y.Offset
			local v1080 = v_u_955.AbsoluteSize.y
			if math.max(v1078, v1080) < v1079 then
				v_u_1069.Position = UDim2.new(0, v_u_1072, 0, -1 * #p_u_1064 * v_u_952.Height - v_u_1072)
			end
			local function v_u_1082(p1081)
				p_u_1067(p1081)
				v_u_1077()
			end
			for v1083, v_u_1084 in pairs(p_u_1064) do
				local v1085 = v_u_1063(v_u_1084, function()
					v_u_1082(v_u_1084)
				end)
				v1085.Size = UDim2.new(1, 0, 0, 16)
				v1085.Position = UDim2.new(0, 0, 0, (v1083 - 1) * v_u_952.Height)
				v1085.ZIndex = v_u_1069.ZIndex
				v1085.Parent = v_u_1069
			end
		end
		v_u_1076(v_u_952.ArrowColor)
		if not p1066 then
			v_u_1073.MouseEnter:connect(function()
				v_u_1073.TextColor3 = v_u_951.TextColor
				v_u_1076(v_u_952.ArrowColorOver)
			end)
			v_u_1073.MouseLeave:connect(function()
				v_u_1073.TextColor3 = v_u_951.TextColor
				if not v_u_1071 then
					v_u_1076(v_u_952.ArrowColor)
				end
			end)
			v_u_1073.MouseButton1Click:connect(function()
				if v_u_1071 then
					v_u_1077()
				else
					v_u_1086()
		...
		return v_u_1068, v_u_1073
	end
	local function v_u_1105(p_u_1088, p_u_1089)
		local v1090 = Instance.new("Frame")
		v1090.Size = UDim2.new(1, 0, 1, 0)
		v1090.BackgroundTransparency = 1
		local v_u_1091 = Instance.new("Frame")
		v_u_1091.BackgroundTransparency = 0
		v_u_1091.SizeConstraint = Enum.SizeConstraint.RelativeXX
		v_u_1091.Size = UDim2.new(1, -2 * v_u_953.OuterBorder, 1, -2 * v_u_953.OuterBorder)
		v_u_1091.BorderSizePixel = v_u_953.BorderSizePixel
		v_u_1091.BorderColor3 = v_u_953.BorderColor
		v_u_1091.Position = UDim2.new(0, v_u_953.OuterBorder, 0, v_u_953.OuterBorder + v_u_951.Height)
		v_u_1091.ZIndex = 5
		v_u_1091.Visible = false
		v_u_1091.BorderSizePixel = v_u_953.OuterBorder
		v_u_1091.BorderColor3 = v_u_953.OuterBorderColor
		v_u_1091.Parent = v1090
		local function v_u_1092()
			v_u_1091.Visible = false
		end
		local function v_u_1093()
			v_u_1091.Visible = not v_u_1091.Visible
		end
		local v1094 = Instance.new("TextButton", v1090)
		v1094.Position = UDim2.new(0, v_u_950.Margin, 0, v_u_950.Margin)
		v1094.Size = UDim2.new(0, v_u_953.BoxSize, 0, v_u_953.BoxSize)
		v1094.Text = ""
		v1094.MouseButton1Click:connect(function()
			if not p_u_1088 then
				v_u_1093()
			end
		end)
		if p_u_1088 then
			v1094.AutoButtonColor = false
		end
		local v1095 = v_u_950.Margin * 2 + v_u_953.BoxSize
		local v1096 = v_u_1053(p_u_1088, function()
			if not p_u_1088 then
				v_u_1093()
			end
		end)
		v1096.Size = UDim2.new(1, -1 * v1095 - v_u_950.Margin, 1, 0)
		v1096.Position = UDim2.new(0, v1095, 0, 0)
		v1096.Parent = v1090
		local v1097 = 1 / v_u_953.ColorsPerRow
		for v1098 = 0, 127 do
			local v_u_1099 = BrickColor.palette(v1098)
			local v1100 = v_u_1099.Color
			local v1101 = v1097 * v1098 % v_u_953.ColorsPerRow
			local v1102 = v1098 / v_u_953.ColorsPerRow
			local v1103 = v1097 * math.floor(v1102)
			local v1104 = Instance.new("TextButton")
			v1104.Text = ""
			v1104.Size = UDim2.new(v1097, 0, v1097, 0)
			v1104.BackgroundColor3 = v1100
			v1104.Position = UDim2.new(v1101, 0, v1103, 0)
			v1104.ZIndex = v_u_1091.ZIndex
			v1104.Parent = v_u_1091
			v1104.MouseButton1Click:connect(function()
				v_u_1092()
				p_u_1089(v_u_1099)
			end)
		end
		return v1090, v1096, v1094
	end
	local function v_u_1111(p1106, _)
		local v1107 = Instance.new("Frame")
		v1107.Size = UDim2.new(1, 0, 1, 0)
		v1107.BackgroundTransparency = 1
		local v1108 = Instance.new("TextButton", v1107)
		v1108.Position = UDim2.new(0, v_u_950.Margin, 0, v_u_950.Margin)
		v1108.Size = UDim2.new(0, v_u_953.BoxSize, 0, v_u_953.BoxSize)
		v1108.Text = ""
		v1108.AutoButtonColor = false
		local v1109 = v_u_950.Margin * 2 + v_u_953.BoxSize
		local v1110 = v_u_1059(p1106)
		v1110.Size = UDim2.new(1, -1 * v1109 - v_u_950.Margin, 1, 0)
		v1110.Position = UDim2.new(0, v1109, 0, 0)
		v1110.Parent = v1107
		return v1107, v1110, v1108
	end
	function CreateCheckbox(p1112, p_u_1113, p_u_1114)
		local v_u_1115 = p1112
		local v_u_1116 = false
		local v1117 = Instance.new("ImageButton")
		v1117.Size = UDim2.new(0, v_u_1021.Width, 0, v_u_1021.Height)
		v1117.BackgroundTransparency = 1
		v1117.ClipsDescendants = true
		local v_u_1118 = Instance.new("ImageLabel", v1117)
		v_u_1118.Name = "SpritesheetImageLabel"
		v_u_1118.Size = UDim2.new(0, v_u_1022.Width, 0, v_u_1022.Height)
		v_u_1118.Image = v_u_1022.Image
		v_u_1118.BackgroundTransparency = 1
		local function v_u_1120()
			local v1119 = v_u_1028((v_u_1032(v_u_1115, p_u_1113, v_u_1116)))
			v_u_1118.Position = UDim2.new(0, -1 * v1119[1], 0, -1 * v1119[2])
		end
		local function v1122(p1121)
			v_u_1115 = p1121
			v_u_1120()
		end
		if not p_u_1113 then
			v1117.MouseEnter:connect(function()
				v_u_1116 = true
				v_u_1120()
			end)
			v1117.MouseLeave:connect(function()
				v_u_1116 = false
				v_u_1120()
			end)
	...
	local v_u_1185 = {
		["default"] = function(p_u_1123, p_u_1124, p1125)
			local v_u_1126 = p_u_1124.Name
			local v_u_1127 = p_u_1124.ValueType
			local v_u_1128 = v_u_1059(p1125)
			v_u_1128.Size = UDim2.new(1, -2 * v_u_950.Margin, 1, 0)
			v_u_1128.Position = UDim2.new(0, v_u_950.Margin, 0, 0)
			local function v_u_1129()
				v_u_1128.Text = v_u_997(p_u_1123[v_u_1126], v_u_1127)
			end
			if not p1125 then
				v_u_1128.FocusLost:connect(function(_)
					Set(p_u_1123, p_u_1124, v_u_1020(v_u_1128.Text, v_u_1127))
					v_u_1129()
				end)
			end
			v_u_1129()
			p_u_1123.Changed:connect(function(p1130)
				if p1130 == v_u_1126 then
					v_u_1129()
				end
			end)
			return v_u_1128
		end,
		["bool"] = function(p_u_1131, p_u_1132, p1133)
			local v_u_1134 = p_u_1132.Name
			local v_u_1135 = p_u_1131[v_u_1134]
			local v1136, v_u_1137 = CreateCheckbox(v_u_1135, p1133, function(_)
				Set(p_u_1131, p_u_1132, not v_u_1135)
			end)
			v1136.Position = UDim2.new(0, v_u_950.Margin, 0, v_u_950.Margin)
			v_u_1137(v_u_1135)
			local function v_u_1138()
				v_u_1135 = p_u_1131[v_u_1134]
				v_u_1137(v_u_1135)
			end
			p_u_1131.Changed:connect(function(p1139)
				if p1139 == v_u_1134 then
					v_u_1138()
				end
			end)
			if p_u_1131:IsA("BoolValue") then
				p_u_1131.Changed:connect(function(_)
					v_u_1138()
				end)
			end
			v_u_1138()
		...
		["BrickColor"] = function(p_u_1140, p_u_1141, p1142)
			local v_u_1143 = p_u_1141.Name
			local v1145, v_u_1146, v_u_1147 = v_u_1105(p1142, function(p1144)
				Set(p_u_1140, p_u_1141, p1144)
			end)
			local function v_u_1149()
				local v1148 = p_u_1140[v_u_1143]
				v_u_1147.BackgroundColor3 = v1148.Color
				v_u_1146.Text = tostring(v1148)
			end
			v_u_1149()
			p_u_1140.Changed:connect(function(p1150)
				if p1150 == v_u_1143 then
					v_u_1149()
				end
			end)
			return v1145
		end,
		["Color3"] = function(p_u_1151, p_u_1152, p1153)
			local v_u_1154 = p_u_1152.Name
			local v1155, v_u_1156, v_u_1157 = v_u_1111(p1153)
			v_u_1156.FocusLost:connect(function(_)
				Set(p_u_1151, p_u_1152, v_u_1020(v_u_1156.Text, "Color3"))
				local v1158 = p_u_1151[v_u_1154]
				v_u_1157.BackgroundColor3 = v1158
				v_u_1156.Text = v_u_997(v1158, "Color3")
			end)
			local function v_u_1160()
				local v1159 = p_u_1151[v_u_1154]
				v_u_1157.BackgroundColor3 = v1159
				v_u_1156.Text = v_u_997(v1159, "Color3")
			end
			v_u_1160()
			p_u_1151.Changed:connect(function(p1161)
				if p1161 == v_u_1154 then
					v_u_1160()
				end
			end)
			return v1155
		end,
		["Enum"] = function(p_u_1162, p_u_1163, p1164)
			local v_u_1165 = p_u_1163.Name
			local v1166 = p_u_1163.ValueType
			local v1167 = p_u_1162[v_u_1165].Name
			local v1168 = {}
			for _, v1169 in pairs(Enum[tostring(v1166)]:GetEnumItems()) do
				local v1170 = v1169.Name
				table.insert(v1168, v1170)
			end
			local v1172, v_u_1173 = v_u_1087(v1168, v1167, p1164, function(p1171)
				Set(p_u_1162, p_u_1163, p1171)
			end)
			local function v_u_1175()
				local v1174 = p_u_1162[v_u_1165].Name
				v_u_1173.Text = tostring(v1174)
			end
			v_u_1175()
			p_u_1162.Changed:connect(function(p1176)
				if p1176 == v_u_1165 then
					v_u_1175()
				end
			end)
			return v1172
		end,
		["Object"] = function(p_u_1177, p_u_1178, p1179)
			local v_u_1180 = p_u_1178.Name
			local v_u_1181 = p_u_1178.ValueType
			local v_u_1182 = v_u_1056(p1179, function() end)
			v_u_1182.Size = UDim2.new(1, -2 * v_u_950.Margin, 1, 0)
			v_u_1182.Position = UDim2.new(0, v_u_950.Margin, 0, 0)
			local function v_u_1183()
				if v_u_966 == p_u_1177 and v_u_965 == true then
					v_u_1182.Text = "Select an Object"
				else
					v_u_1182.Text = v_u_997(p_u_1177[v_u_1180], v_u_1181)
				end
			end
			if not p1179 then
				v_u_1182.MouseButton1Click:connect(function()
					if v_u_965 then
						v_u_965 = false
						v_u_1183()
					else
				...
				v_u_1182.Cancel.Visible = true
				v_u_1182.Cancel.MouseButton1Click:connect(function()
					p_u_1177[v_u_1180] = nil
				end)
			end
			v_u_1183()
			p_u_1177.Changed:connect(function(p1184)
				if p1184 == v_u_1180 then
					v_u_1183()
				end
			end)
			if p_u_1177:IsA("ObjectValue") then
				p_u_1177.Changed:connect(function(_)
					v_u_1183()
				end)
			end
			return v_u_1182
	...
	function GetControl(p1186, p1187, p1188)
		local v1189 = p1187.ValueType
		if v_u_1185[v1189] then
			return v_u_1185[v1189](p1186, p1187, p1188)
		elseif v_u_945.IsEnum(v1189) then
			return v_u_1185.Enum(p1186, p1187, p1188)
		else
			return v_u_1185.default(p1186, p1187, p1188)
		end
	end
	function CanEditObject(_)
		local _ = v_u_901.LocalPlayer.Character
		return v_u_944.CanEdit
	end
	function CanEditProperty(p1190, p1191)
		local v1192 = p1191.tags
		for _, v1193 in pairs(v1192) do
			if v1193 == "readonly" then
				return false
			end
		end
		return CanEditObject(p1190)
	end
	local function v_u_1197(p1194)
		local v1195 = p1194.tags
		for _, v1196 in pairs(v1195) do
			if v1196 == "deprecated" or v1196 == "hidden" or v1196 == "writeonly" then
				return true
			end
		end
		return false
	end
	function Set(_, p1198, p_u_1199)
		local v_u_1200 = p1198.Name
		local _ = p1198.ValueType
		if p_u_1199 ~= nil then
			for _, v_u_1201 in pairs(v_u_969()) do
				if CanEditProperty(v_u_1201, p1198) then
					pcall(function()
						v_u_1201[v_u_1200] = p_u_1199
					end)
				end
			end
		end
	end
	function CreateRow(p1202, p1203, p1204)
		local v1205 = p1203.Name
		local v1206 = p1203.ValueType
		local _ = p1202[v1205]
		local v_u_1207 = v_u_951.BackgroundColor
		if p1204 then
			v_u_1207 = v_u_951.BackgroundColorAlternate
		end
		local v1208 = not CanEditProperty(p1202, p1203)
		local v1209 = (v1206 == "Instance" or v1205 == "Parent") and true or v1208
		local v1210 = Instance.new("Frame")
		v1210.Size = UDim2.new(1, 0, 0, v_u_951.Height)
		v1210.BackgroundTransparency = 1
		v1210.Name = "Row"
		local v_u_1211 = v_u_1046()
		v_u_1211.Parent = v1210
		v_u_1211.ClipsDescendants = true
		local v1212 = v_u_1049(v1209)
		v1212.Text = v1205
		v1212.Size = UDim2.new(1, -1 * v_u_951.TitleMarginLeft, 1, 0)
		v1212.Position = UDim2.new(0, v_u_951.TitleMarginLeft, 0, 0)
		v1212.Parent = v_u_1211
		local v_u_1213 = v_u_1046()
		v_u_1213.Size = UDim2.new(0.5, -1, 1, 0)
		v_u_1213.Position = UDim2.new(0.5, 0, 0, 0)
		v_u_1213.Parent = v1210
		GetControl(p1202, p1203, v1209).Parent = v_u_1213
		v1210.MouseEnter:connect(function()
			v_u_1211.BackgroundColor3 = v_u_951.BackgroundColorMouseover
			v_u_1213.BackgroundColor3 = v_u_951.BackgroundColorMouseover
		end)
		v1210.MouseLeave:connect(function()
			v_u_1211.BackgroundColor3 = v_u_1207
			v_u_1213.BackgroundColor3 = v_u_1207
		end)
		v_u_1211.BackgroundColor3 = v_u_1207
		v_u_1213.BackgroundColor3 = v_u_1207
		return v1210
	...
	function ClearPropertiesList()
		for _, v1214 in pairs(ContentFrame:GetChildren()) do
			v1214:Destroy()
		end
	end
	v_u_899((v954:FindFirstChild("Selection", 1)))
	function displayProperties(p1215)
		for _, v_u_1216 in pairs(p1215) do
			pcall(function()
				local v1217 = CreateRow(v_u_1216.object, v_u_1216.propertyData, numRows % 2 == 0)
				v1217.Position = UDim2.new(0, 0, 0, numRows * v_u_951.Height)
				v1217.Parent = ContentFrame
				numRows = numRows + 1
			end)
		end
	end
	function checkForDupe(p1218, p1219)
		for _, v1220 in pairs(p1219) do
			if v1220.propertyData.Name == p1218.Name and v1220.propertyData.ValueType == p1218.ValueType then
				return true
			end
		end
		return false
	end
	function sortProps(p1221)
		table.sort(p1221, function(p1222, p1223)
			return p1222.propertyData.Name < p1223.propertyData.Name
		end)
	end
	function showProperties(p1224)
		ClearPropertiesList()
		if p1224 ~= nil then
			local v_u_1225 = {}
			local v1226 = {}
			numRows = 0
			for _, v_u_1227 in pairs(p1224) do
				if not v1226[v_u_1227.className] then
					v1226[v_u_1227.className] = true
					for _, v_u_1228 in pairs(v_u_945.GetProperties(v_u_1227.className)) do
						local _, _ = pcall(function()
							if
								not v_u_1197(v_u_1228)
								and not checkForDupe(v_u_1228, v_u_1225)
								and (
									string.find(string.lower(v_u_1228.Name), string.lower(v_u_964.Text))
									or not searchingProperties()
								)
							then
								table.insert(v_u_1225, { ["propertyData"] = v_u_1228, ["object"] = v_u_1227 })
							end
						end)
					end
				end
			...
			sortProps(v_u_1225)
			displayProperties(v_u_1225)
			ContentFrame.Size = UDim2.new(1, 0, 0, numRows * v_u_951.Height)
			scrollBar.ScrollIndex = 0
			scrollBar.TotalSpace = numRows * v_u_951.Height
			scrollBar.Update()
		end
	end
	local v_u_1229 = {
		["Background"] = Color3.new(0.9137254901960784, 0.9137254901960784, 0.9137254901960784),
		["Border"] = Color3.new(0.5843137254901961, 0.5843137254901961, 0.5843137254901961),
		["Selected"] = Color3.new(0.24705882352941178, 0.4666666666666667, 0.7411764705882353),
		["BorderSelected"] = Color3.new(0.21568627450980393, 0.41568627450980394, 0.6549019607843137),
		["Text"] = Color3.new(0, 0, 0),
		["TextDisabled"] = Color3.new(0.5019607843137255, 0.5019607843137255, 0.5019607843137255),
		["TextSelected"] = Color3.new(1, 1, 1),
		["Button"] = Color3.new(0.8666666666666667, 0.8666666666666667, 0.8666666666666667),
	...
	local v_u_1230 = {}
	function SetZIndex(p1231, p1232)
		if not v_u_1230[p1231] then
			v_u_1230[p1231] = true
			if p1231:IsA("GuiObject") then
				p1231.ZIndex = p1232
			end
			local v1233 = p1231:GetChildren()
			for v1234 = 1, #v1233 do
				SetZIndex(v1233[v1234], p1232)
			end
			v_u_1230[p1231] = nil
		end
	end
	function SetZIndexOnChanged(p_u_1235)
		return p_u_1235.Changed:connect(function(p1236)
			if p1236 == "ZIndex" then
				SetZIndex(p_u_1235, p_u_1235.ZIndex)
			end
		end)
	end
	function Create(p1237, p1238)
		if type(p1237) == "string" then
			p1237 = Instance.new(p1237)
		end
		for v1239, v1240 in pairs(p1238) do
			if type(v1239) == "number" then
				v1240.Parent = p1237
			else
				p1237[v1239] = v1240
			end
	...
	function GetScreen(p1241)
		if p1241 == nil then
			return nil
		end
		while not p1241:IsA("ScreenGui") do
			p1241 = p1241.Parent
			if p1241 == nil then
				return nil
			end
	...
	function ResetButtonColor(p1242)
		local v1243 = p1242.Active
		p1242.Active = not v1243
		p1242.Active = v1243
	end
	function ArrowGraphic(p_u_1244, p1245, p1246, p1247)
		local v1248 = Create(
			"Frame",
			{
				["Name"] = "Arrow Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1244, 0, p_u_1244),
				["Transparency"] = 1,
			}
		)
		if not p1247 then
			p1247 = Instance.new("Frame")
			p1247.BorderSizePixel = 0
		end
		local v1249 = nil
		local v1250
		if p1245 == nil or p1245 == "Up" then
			v1250 = function(p1251, p1252)
				return p1251, p1252
			end
		elseif p1245 == "Down" then
			v1250 = function(p1253, p1254)
				return UDim2.new(0, p1253.X.Offset, 0, p_u_1244 - p1253.Y.Offset - 1), p1254
			end
		elseif p1245 == "Left" then
			v1250 = function(p1255, p1256)
				return UDim2.new(0, p1255.Y.Offset, 0, p1255.X.Offset), UDim2.new(0, p1256.Y.Offset, 0, p1256.X.Offset)
			end
		else
			v1250 = p1245 == "Right"
					and function(p1257, p1258)
						return UDim2.new(0, p_u_1244 - p1257.Y.Offset - 1, 0, p1257.X.Offset),
							UDim2.new(0, p1258.Y.Offset, 0, p1258.X.Offset)
					end
				or v1249
		end
		local v1263 = p1246
				and function(p1259, p1260)
					return UDim2.new(p1259.X.Offset / p_u_1244, 0, p1259.Y.Offset / p_u_1244, 0),
						UDim2.new(p1260.X.Offset / p_u_1244, 0, p1260.Y.Offset / p_u_1244, 0)
				end
			or function(p1261, p1262)
				return p1261, p1262
			end
		local v1264 = p_u_1244 / 4
		local v1265 = math.floor(v1264)
		if p_u_1244 % 2 == 0 then
			local v1266 = p_u_1244 / 2 - 1
			for v1267 = 0, v1266 do
				local v1268 = p1247:Clone()
				local v1269, v1270 =
					v1263(v1250(UDim2.new(0, v1266 - v1267, 0, v1265 + v1267), UDim2.new(0, (v1267 + 1) * 2, 0, 1)))
				v1268.Position = v1269
				v1268.Size = v1270
				v1268.Parent = v1248
			end
		else
			local v1271 = (p_u_1244 - 1) / 2
			for v1272 = 0, v1271 do
				local v1273 = p1247:Clone()
				local v1274, v1275 =
					v1263(v1250(UDim2.new(0, v1271 - v1272, 0, v1265 + v1272), UDim2.new(0, v1272 * 2 + 1, 0, 1)))
				v1273.Position = v1274
				v1273.Size = v1275
				v1273.Parent = v1248
			end
		end
		if 1 < p_u_1244 % 4 then
			local v1276 = p1247:Clone()
			local v1277, v1278 = v1263(v1250(UDim2.new(0, 0, 0, p_u_1244 - v1265 - 1), UDim2.new(0, p_u_1244, 0, 1)))
			v1276.Position = v1277
			v1276.Size = v1278
			v1276.Parent = v1248
		end
		return v1248
	end
	function GripGraphic(p_u_1279, p1280, p1281, p1282, p1283)
		local v1284 = Create(
			"Frame",
			{
				["Name"] = "Grip Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1279.x, 0, p_u_1279.y),
				["Transparency"] = 1,
			}
		)
		if not p1283 then
			p1283 = Instance.new("Frame")
			p1283.BorderSizePixel = 0
		end
		local v1285 = p1281 or 2
		local v1288 = p1282
				and function(p1286)
					return UDim2.new(p1286.X.Offset / p_u_1279.x, 0, p1286.Y.Offset / p_u_1279.y, 0)
				end
			or function(p1287)
				return p1287
			end
		if p1280 == "Vertical" then
			for v1289 = 0, p_u_1279.x - 1, v1285 do
				local v1290 = p1283:Clone()
				v1290.Size = v1288(UDim2.new(0, 1, 0, p_u_1279.y))
				v1290.Position = v1288(UDim2.new(0, v1289, 0, 0))
				v1290.Parent = v1284
			end
			return v1284
		else
			if p1280 == nil or p1280 == "Horizontal" then
				for v1291 = 0, p_u_1279.y - 1, v1285 do
					local v1292 = p1283:Clone()
					v1292.Size = v1288(UDim2.new(0, p_u_1279.x, 0, 1))
					v1292.Position = v1288(UDim2.new(0, 0, 0, v1291))
					v1292.Parent = v1284
				end
			end
			return v1284
	...
	local v_u_1303 = {
		["__index"] = {
			["GetScrollPercent"] = function(p1293)
				return p1293.ScrollIndex / (p1293.TotalSpace - p1293.VisibleSpace)
			end,
			["CanScrollDown"] = function(p1294)
				return p1294.ScrollIndex + p1294.VisibleSpace < p1294.TotalSpace
			end,
			["CanScrollUp"] = function(p1295)
				return 0 < p1295.ScrollIndex
			end,
			["ScrollDown"] = function(p1296)
				p1296.ScrollIndex = p1296.ScrollIndex + p1296.PageIncrement
				p1296:Update()
			end,
			["ScrollUp"] = function(p1297)
				p1297.ScrollIndex = p1297.ScrollIndex - p1297.PageIncrement
				p1297:Update()
			end,
			["ScrollTo"] = function(p1298, p1299)
				p1298.ScrollIndex = p1299
				p1298:Update()
			end,
			["SetScrollPercent"] = function(p1300, p1301)
				local v1302 = (p1300.TotalSpace - p1300.VisibleSpace) * p1301 + 0.5
				p1300.ScrollIndex = math.floor(v1302)
				p1300:Update()
			end,
		},
	}
	v_u_1303.__index.CanScrollRight = v_u_1303.__index.CanScrollDown
	v_u_1303.__index.CanScrollLeft = v_u_1303.__index.CanScrollUp
	v_u_1303.__index.ScrollLeft = v_u_1303.__index.ScrollUp
	v_u_1303.__index.ScrollRight = v_u_1303.__index.ScrollDown
	function ScrollBar(p1304)
		local v_u_1305 = Create(
			"Frame",
			{
				["Name"] = "ScrollFrame",
				["Position"] = p1304 and UDim2.new(0, 0, 1, -16) or UDim2.new(1, -16, 0, 0),
				["Size"] = p1304 and UDim2.new(1, 0, 0, 16) or UDim2.new(0, 16, 1, 0),
				["BackgroundTransparency"] = 1,
				Create(
					"ImageButton",
					{
						["Name"] = "ScrollDown",
						["Position"] = p1304 and UDim2.new(1, -16, 0, 0) or UDim2.new(0, 0, 1, -16),
						["Size"] = UDim2.new(0, 16, 0, 16),
						["BackgroundColor3"] = v_u_1229.Button,
						["BorderColor3"] = v_u_1229.Border,
					}
				),
				Create(
					"ImageButton",
				...
				Create(
					...
					{
						["Name"] = "ScrollBar",
						["Size"] = p1304 and UDim2.new(1, -32, 1, 0) or UDim2.new(1, 0, 1, -32),
						["Position"] = p1304 and UDim2.new(0, 16, 0, 0) or UDim2.new(0, 0, 0, 16),
						["AutoButtonColor"] = false,
						["BackgroundColor3"] = Color3.new(0.94902, 0.94902, 0.94902),
						["BorderColor3"] = v_u_1229.Border,
						Create(
		...
		local v1306 =
			Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = v_u_1229.Border })
		local v_u_1307 = v_u_1305.ScrollDown
		local v_u_1308 = ArrowGraphic(8, p1304 and "Right" or "Down", true, v1306)
		v_u_1308.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1308.Parent = v_u_1307
		local v_u_1309 = v_u_1305.ScrollUp
		local v_u_1310 = ArrowGraphic(8, p1304 and "Left" or "Up", true, v1306)
		v_u_1310.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1310.Parent = v_u_1309
		local v_u_1311 = v_u_1305.ScrollBar
		local v_u_1312 = v_u_1311.ScrollThumb
		local v1313 = GripGraphic(Vector2.new(6, 6), p1304 and "Vertical" or "Horizontal", 2, v1306)
		v1313.Position = UDim2.new(0.5, -3, 0.5, -3)
		v1313.Parent = v_u_1312
		local v_u_1314 = Create(
			"ImageButton",
			{
				["Name"] = "MouseDrag",
				["Position"] = UDim2.new(-0.25, 0, -0.25, 0),
		...
		local v_u_1315 = setmetatable(
			{ ["GUI"] = v_u_1305, ["ScrollIndex"] = 0, ["VisibleSpace"] = 0, ["TotalSpace"] = 0, ["PageIncrement"] = 1 },
			v_u_1303
		)
		local v_u_1318 = p1304
				and function()
					v_u_1312.Size = UDim2.new(v_u_1315.VisibleSpace / v_u_1315.TotalSpace, 0, 0, 16)
					if v_u_1312.AbsoluteSize.x < 16 then
						v_u_1312.Size = UDim2.new(0, 16, 0, 16)
					end
					local v1316 = v_u_1311.AbsoluteSize.x
					v_u_1312.Position =
						UDim2.new(v_u_1315:GetScrollPercent() * (v1316 - v_u_1312.AbsoluteSize.x) / v1316, 0, 0, 0)
				end
			or function()
				v_u_1312.Size = UDim2.new(0, 16, v_u_1315.VisibleSpace / v_u_1315.TotalSpace, 0)
				if v_u_1312.AbsoluteSize.y < 16 then
					v_u_1312.Size = UDim2.new(0, 16, 0, 16)
				end
				local v1317 = v_u_1311.AbsoluteSize.y
				v_u_1312.Position =
					UDim2.new(0, 0, v_u_1315:GetScrollPercent() * (v1317 - v_u_1312.AbsoluteSize.y) / v1317, 0)
			end
		local v_u_1319 = nil
		local v_u_1320 = nil
		local v_u_1321 = { ["BackgroundColor3"] = v_u_1229.Border, ["BackgroundTransparency"] = 0 }
		local v_u_1322 = { ["BackgroundColor3"] = v_u_1229.Border, ["BackgroundTransparency"] = 0.7 }
		local function v1334()
			local v1323 = v_u_1315.TotalSpace
			local v1324 = v_u_1315.VisibleSpace
			local v1325 = v_u_1315.ScrollIndex
			if v1324 <= v1323 then
				if 0 < v1325 then
					if v1323 < v1325 + v1324 then
						v_u_1315.ScrollIndex = v1323 - v1324
					end
				else
					v_u_1315.ScrollIndex = 0
				end
			else
				v_u_1315.ScrollIndex = 0
			end
			if not v_u_1315.UpdateCallback or v_u_1315.UpdateCallback(v_u_1315) ~= false then
				local v1326 = v_u_1315:CanScrollDown()
				local v1327 = v_u_1315:CanScrollUp()
				if v1326 ~= v_u_1319 then
					v_u_1319 = v1326
					v_u_1307.Active = v1326
					v_u_1307.AutoButtonColor = v1326
					local v1328 = v_u_1308:GetChildren()
					local v1329 = v1326 and v_u_1321
					if not v1329 then
						v1329 = v_u_1322
					end
					for v1330 = 1, #v1328 do
						Create(v1328[v1330], v1329)
					end
				end
				if v1327 ~= v_u_1320 then
					v_u_1320 = v1327
					v_u_1309.Active = v1327
					v_u_1309.AutoButtonColor = v1327
					local v1331 = v_u_1310:GetChildren()
					local v1332 = v1327 and v_u_1321
					if not v1332 then
						v1332 = v_u_1322
					end
					for v1333 = 1, #v1331 do
						Create(v1331[v1333], v1332)
					end
				end
				v_u_1312.Visible = v1326 or v1327
				v_u_1318()
			end
		end
		v_u_1315.Update = v1334
		SetZIndexOnChanged(v_u_1305)
		local v_u_1335 = 0
		v_u_1307.MouseButton1Down:connect(function()
			v_u_1335 = tick()
			local v1336 = v_u_1335
			local v_u_1337 = nil
			v_u_1337 = v_u_1314.MouseButton1Up:connect(function()
				v_u_1335 = tick()
				v_u_1314.Parent = nil
				ResetButtonColor(v_u_1307)
				v_u_1337:disconnect()
				drag = nil
			end)
			v_u_1314.Parent = GetScreen(v_u_1305)
			v_u_1315:ScrollDown()
			wait(0.2)
			while v_u_1335 == v1336 do
				v_u_1315:ScrollDown()
				if not v_u_1315:CanScrollDown() then
					break
				end
				wait()
			end
		end)
		v_u_1307.MouseButton1Up:connect(function()
			v_u_1335 = tick()
		end)
		v_u_1309.MouseButton1Down:connect(function()
			v_u_1335 = tick()
			local v1338 = v_u_1335
			local v_u_1339 = nil
			v_u_1339 = v_u_1314.MouseButton1Up:connect(function()
				v_u_1335 = tick()
				v_u_1314.Parent = nil
				ResetButtonColor(v_u_1309)
				v_u_1339:disconnect()
				drag = nil
			end)
			v_u_1314.Parent = GetScreen(v_u_1305)
			v_u_1315:ScrollUp()
			wait(0.2)
			while v_u_1335 == v1338 do
				v_u_1315:ScrollUp()
				if not v_u_1315:CanScrollUp() then
					break
				end
				wait()
			end
		end)
		v_u_1309.MouseButton1Up:connect(function()
			v_u_1335 = tick()
		end)
		if p1304 then
			v_u_1311.MouseButton1Down:connect(function(p1340, _)
				v_u_1335 = tick()
				local v1341 = v_u_1335
				local v_u_1342 = nil
				v_u_1342 = v_u_1314.MouseButton1Up:connect(function()
					v_u_1335 = tick()
					v_u_1314.Parent = nil
					ResetButtonColor(v_u_1309)
					v_u_1342:disconnect()
				...
				v_u_1314.Parent = GetScreen(v_u_1305)
				if v_u_1312.AbsolutePosition.x < p1340 then
					v_u_1315:ScrollTo(v_u_1315.ScrollIndex + v_u_1315.VisibleSpace)
					wait(0.2)
					while v_u_1335 == v1341 and p1340 >= v_u_1312.AbsolutePosition.x + v_u_1312.AbsoluteSize.x do
						v_u_1315:ScrollTo(v_u_1315.ScrollIndex + v_u_1315.VisibleSpace)
						wait()
					end
				else
					v_u_1315:ScrollTo(v_u_1315.ScrollIndex - v_u_1315.VisibleSpace)
					wait(0.2)
					while v_u_1335 == v1341 and v_u_1312.AbsolutePosition.x >= p1340 do
						v_u_1315:ScrollTo(v_u_1315.ScrollIndex - v_u_1315.VisibleSpace)
						wait()
					end
				end
			...
			v_u_1311.MouseButton1Down:connect(function(_, p1343)
				v_u_1335 = tick()
				local v1344 = v_u_1335
				local v_u_1345 = nil
				v_u_1345 = v_u_1314.MouseButton1Up:connect(function()
					v_u_1335 = tick()
					v_u_1314.Parent = nil
					ResetButtonColor(v_u_1309)
					v_u_1345:disconnect()
				...
				v_u_1314.Parent = GetScreen(v_u_1305)
				if v_u_1312.AbsolutePosition.y < p1343 then
					v_u_1315:ScrollTo(v_u_1315.ScrollIndex + v_u_1315.VisibleSpace)
					wait(0.2)
					while v_u_1335 == v1344 and p1343 >= v_u_1312.AbsolutePosition.y + v_u_1312.AbsoluteSize.y do
						v_u_1315:ScrollTo(v_u_1315.ScrollIndex + v_u_1315.VisibleSpace)
						wait()
					end
				else
					v_u_1315:ScrollTo(v_u_1315.ScrollIndex - v_u_1315.VisibleSpace)
					wait(0.2)
					while v_u_1335 == v1344 and v_u_1312.AbsolutePosition.y >= p1343 do
						v_u_1315:ScrollTo(v_u_1315.ScrollIndex - v_u_1315.VisibleSpace)
						wait()
					end
				end
		...
		if p1304 then
			v_u_1312.MouseButton1Down:connect(function(p1346, _)
				v_u_1335 = tick()
				local v_u_1347 = p1346 - v_u_1312.AbsolutePosition.x
				local v_u_1348 = nil
				local v_u_1354 = v_u_1314.MouseMoved:connect(function(p1349, _)
					local v1350 = v_u_1311.AbsolutePosition.x
					local v1351 = v_u_1311.AbsoluteSize.x - v_u_1312.AbsoluteSize.x
					local v1352 = v1350 + v1351
					local v1353 = p1349 - v_u_1347
					if v1353 < v1350 and v1350 then
						v1353 = v1350
					elseif v1352 < v1353 then
						if v1352 then
							v1353 = v1352
						end
					end
					v_u_1315:SetScrollPercent((v1353 - v1350) / v1351)
				end)
				v_u_1348 = v_u_1314.MouseButton1Up:connect(function()
					v_u_1335 = tick()
					v_u_1314.Parent = nil
					ResetButtonColor(v_u_1312)
					v_u_1354:disconnect()
					v_u_1354 = nil
					v_u_1348:disconnect()
					drag = nil
			...
			v_u_1312.MouseButton1Down:connect(function(_, p1355)
				v_u_1335 = tick()
				local v_u_1356 = p1355 - v_u_1312.AbsolutePosition.y
				local v_u_1357 = nil
				local v_u_1363 = v_u_1314.MouseMoved:connect(function(_, p1358)
					local v1359 = v_u_1311.AbsolutePosition.y
					local v1360 = v_u_1311.AbsoluteSize.y - v_u_1312.AbsoluteSize.y
					local v1361 = v1359 + v1360
					local v1362 = p1358 - v_u_1356
					if v1362 < v1359 and v1359 then
						v1362 = v1359
					elseif v1361 < v1362 then
						if v1361 then
							v1362 = v1361
						end
					end
					v_u_1315:SetScrollPercent((v1362 - v1359) / v1360)
				end)
				v_u_1357 = v_u_1314.MouseButton1Up:connect(function()
					v_u_1335 = tick()
					v_u_1314.Parent = nil
					ResetButtonColor(v_u_1312)
					v_u_1363:disconnect()
		...
		function v_u_1315.Destroy(_)
			v_u_1305:Destroy()
			v_u_1314:Destroy()
			for v1364 in pairs(v_u_1315) do
				v_u_1315[v1364] = nil
			end
			setmetatable(v_u_1315, nil)
		end
		v1334()
		return v_u_1315
	end
	local v_u_1365 = Instance.new("Frame")
	v_u_1365.Name = "MainFrame"
	v_u_1365.Size = UDim2.new(1, -16, 1, 0)
	v_u_1365.Position = UDim2.new(0, 0, 0, 0)
	v_u_1365.BackgroundTransparency = 1
	v_u_1365.ClipsDescendants = true
	v_u_1365.Parent = v_u_955
	ContentFrame = Instance.new("Frame")
	ContentFrame.Name = "ContentFrame"
	ContentFrame.Size = UDim2.new(1, 0, 0, 0)
	ContentFrame.BackgroundTransparency = 1
	ContentFrame.Parent = v_u_1365
	scrollBar = ScrollBar(false)
	scrollBar.PageIncrement = 1
	Create(
		scrollBar.GUI,
		{ ["Position"] = UDim2.new(1, -16, 0, 0), ["Size"] = UDim2.new(0, 16, 1, 0), ["Parent"] = v_u_955 }
	)
	...
	function scrollBar.UpdateCallback(_)
		scrollBar.TotalSpace = ContentFrame.AbsoluteSize.Y
		scrollBar.VisibleSpace = v_u_1365.AbsoluteSize.Y
		ContentFrame.Position =
			UDim2.new(ContentFrame.Position.X.Scale, ContentFrame.Position.X.Offset, 0, -1 * scrollBar.ScrollIndex)
	end
	function scrollBarH.UpdateCallback(_) end
	v_u_1365.Changed:connect(function(p1366)
		if p1366 == "AbsoluteSize" then
			local v1367 = scrollBarH
			local v1368 = v_u_1365.AbsoluteSize.x
			v1367.VisibleSpace = math.ceil(v1368)
			scrollBarH:Update()
			local v1369 = scrollBar
			local v1370 = v_u_1365.AbsoluteSize.y
			v1369.VisibleSpace = math.ceil(v1370)
			scrollBar:Update()
		end
	end)
	local v_u_1371 = v_u_951.Height
	v_u_955.MouseWheelForward:connect(function()
		if v_u_1371 < scrollBar.VisibleSpace - 1 then
			scrollBar:ScrollTo(scrollBar.ScrollIndex - v_u_1371)
		else
			scrollBar:ScrollTo(scrollBar.ScrollIndex - scrollBar.VisibleSpace)
		end
	end)
	v_u_955.MouseWheelBackward:connect(function()
		if v_u_1371 < scrollBar.VisibleSpace - 1 then
			scrollBar:ScrollTo(scrollBar.ScrollIndex + v_u_1371)
		else
			scrollBar:ScrollTo(scrollBar.ScrollIndex + scrollBar.VisibleSpace)
	...
	local v1372 = scrollBar
	local v1373 = v_u_1365.AbsoluteSize.y
	v1372.VisibleSpace = math.ceil(v1373)
	scrollBar:Update()
	showProperties(v_u_969())
	v958.Event:connect(function()
		showProperties(v_u_969())
	end)
	v961.Event:connect(function(p_u_1374)
		if v_u_965 then
			v_u_965 = false
			if p_u_1374 then
				pcall(function()
					Set(v_u_966, v_u_967, p_u_1374)
				end)
			end
		end
	end)
	v_u_964.Changed:connect(function(p1375)
		if p1375 == "Text" then
			showProperties(v_u_969())
		end
	end)
	function v959.OnInvoke()
		return v_u_945
	end
	function v960.OnInvoke()
		return v_u_965
	end
end)
spawn(function()
	local v_u_1376 = v_u_164.ScriptEditor
	local v_u_1377 = v_u_1376:WaitForChild("EditorGrid")
	local v_u_1378 = ""
	game:GetService("UserInputService")
	local v1379 = game.Players.LocalPlayer:GetMouse()
	local v1380 = v_u_1376:WaitForChild("TopBar")
	local v_u_1381 = v1380:WaitForChild("ScriptBar")
	local v_u_1382 = v1380:WaitForChild("ScriptBarLeft")
	local v_u_1383 = v1380:WaitForChild("ScriptBarRight")
	local v1384 = v1380:WaitForChild("Clipboard")
	local v_u_1385 = v1380:WaitForChild("Entry")
	local v1386 = v_u_1376:WaitForChild("OpenScript")
	local v1387 = v_u_1376:WaitForChild("Close")
	local v_u_1388 = {}
	local v_u_1389 = 0
	local v_u_1390 = {
		["Background"] = Color3.new(0.9137254901960784, 0.9137254901960784, 0.9137254901960784),
	...
	local v_u_1391 = {}
	function SetZIndex(p1392, p1393)
		if not v_u_1391[p1392] then
			v_u_1391[p1392] = true
			if p1392:IsA("GuiObject") then
				p1392.ZIndex = p1393
			end
			local v1394 = p1392:GetChildren()
			for v1395 = 1, #v1394 do
				SetZIndex(v1394[v1395], p1393)
			end
			v_u_1391[p1392] = nil
		end
	end
	function SetZIndexOnChanged(p_u_1396)
		return p_u_1396.Changed:connect(function(p1397)
			if p1397 == "ZIndex" then
				SetZIndex(p_u_1396, p_u_1396.ZIndex)
			end
		end)
	end
	function Create(p1398, p1399)
		if type(p1398) == "string" then
			p1398 = Instance.new(p1398)
		end
		for v1400, v1401 in pairs(p1399) do
			if type(v1400) == "number" then
				v1401.Parent = p1398
			else
				p1398[v1400] = v1401
			end
	...
	function GetScreen(p1402)
		if p1402 == nil then
			return nil
		end
		while not p1402:IsA("ScreenGui") do
			p1402 = p1402.Parent
			if p1402 == nil then
				return nil
			end
	...
	function ResetButtonColor(p1403)
		local v1404 = p1403.Active
		p1403.Active = not v1404
		p1403.Active = v1404
	end
	function ArrowGraphic(p_u_1405, p1406, p1407, p1408)
		local v1409 = Create(
			"Frame",
			{
				["Name"] = "Arrow Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1405, 0, p_u_1405),
				["Transparency"] = 1,
			}
		)
		if not p1408 then
			p1408 = Instance.new("Frame")
			p1408.BorderSizePixel = 0
		end
		local v1410 = nil
		local v1411
		if p1406 == nil or p1406 == "Up" then
			v1411 = function(p1412, p1413)
				return p1412, p1413
			end
		elseif p1406 == "Down" then
			v1411 = function(p1414, p1415)
				return UDim2.new(0, p1414.X.Offset, 0, p_u_1405 - p1414.Y.Offset - 1), p1415
			end
		elseif p1406 == "Left" then
			v1411 = function(p1416, p1417)
				return UDim2.new(0, p1416.Y.Offset, 0, p1416.X.Offset), UDim2.new(0, p1417.Y.Offset, 0, p1417.X.Offset)
			end
		else
			v1411 = p1406 == "Right"
					and function(p1418, p1419)
						return UDim2.new(0, p_u_1405 - p1418.Y.Offset - 1, 0, p1418.X.Offset),
							UDim2.new(0, p1419.Y.Offset, 0, p1419.X.Offset)
					end
				or v1410
		end
		local v1424 = p1407
				and function(p1420, p1421)
					return UDim2.new(p1420.X.Offset / p_u_1405, 0, p1420.Y.Offset / p_u_1405, 0),
						UDim2.new(p1421.X.Offset / p_u_1405, 0, p1421.Y.Offset / p_u_1405, 0)
				end
			or function(p1422, p1423)
				return p1422, p1423
			end
		local v1425 = p_u_1405 / 4
		local v1426 = math.floor(v1425)
		if p_u_1405 % 2 == 0 then
			local v1427 = p_u_1405 / 2 - 1
			for v1428 = 0, v1427 do
				local v1429 = p1408:Clone()
				local v1430, v1431 =
					v1424(v1411(UDim2.new(0, v1427 - v1428, 0, v1426 + v1428), UDim2.new(0, (v1428 + 1) * 2, 0, 1)))
				v1429.Position = v1430
				v1429.Size = v1431
				v1429.Parent = v1409
			end
		else
			local v1432 = (p_u_1405 - 1) / 2
			for v1433 = 0, v1432 do
				local v1434 = p1408:Clone()
				local v1435, v1436 =
					v1424(v1411(UDim2.new(0, v1432 - v1433, 0, v1426 + v1433), UDim2.new(0, v1433 * 2 + 1, 0, 1)))
				v1434.Position = v1435
				v1434.Size = v1436
				v1434.Parent = v1409
			end
		end
		if 1 < p_u_1405 % 4 then
			local v1437 = p1408:Clone()
			local v1438, v1439 = v1424(v1411(UDim2.new(0, 0, 0, p_u_1405 - v1426 - 1), UDim2.new(0, p_u_1405, 0, 1)))
			v1437.Position = v1438
			v1437.Size = v1439
			v1437.Parent = v1409
		end
		return v1409
	end
	function GripGraphic(p_u_1440, p1441, p1442, p1443, p1444)
		local v1445 = Create(
			"Frame",
			{
				["Name"] = "Grip Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1440.x, 0, p_u_1440.y),
				["Transparency"] = 1,
			}
		)
		if not p1444 then
			p1444 = Instance.new("Frame")
			p1444.BorderSizePixel = 0
		end
		local v1446 = p1442 or 2
		local v1449 = p1443
				and function(p1447)
					return UDim2.new(p1447.X.Offset / p_u_1440.x, 0, p1447.Y.Offset / p_u_1440.y, 0)
				end
			or function(p1448)
				return p1448
			end
		if p1441 == "Vertical" then
			for v1450 = 0, p_u_1440.x - 1, v1446 do
				local v1451 = p1444:Clone()
				v1451.Size = v1449(UDim2.new(0, 1, 0, p_u_1440.y))
				v1451.Position = v1449(UDim2.new(0, v1450, 0, 0))
				v1451.Parent = v1445
			end
			return v1445
		else
			if p1441 == nil or p1441 == "Horizontal" then
				for v1452 = 0, p_u_1440.y - 1, v1446 do
					local v1453 = p1444:Clone()
					v1453.Size = v1449(UDim2.new(0, p_u_1440.x, 0, 1))
					v1453.Position = v1449(UDim2.new(0, 0, 0, v1452))
					v1453.Parent = v1445
				end
			end
			return v1445
	...
	local v_u_1464 = {
		["__index"] = {
			["GetScrollPercent"] = function(p1454)
				return p1454.ScrollIndex / (p1454.TotalSpace - p1454.VisibleSpace)
			end,
			["CanScrollDown"] = function(p1455)
				return p1455.ScrollIndex + p1455.VisibleSpace < p1455.TotalSpace
			end,
			["CanScrollUp"] = function(p1456)
				return 0 < p1456.ScrollIndex
			end,
			["ScrollDown"] = function(p1457)
				p1457.ScrollIndex = p1457.ScrollIndex + p1457.PageIncrement
				p1457:Update()
			end,
			["ScrollUp"] = function(p1458)
				p1458.ScrollIndex = p1458.ScrollIndex - p1458.PageIncrement
				p1458:Update()
			end,
			["ScrollTo"] = function(p1459, p1460)
				p1459.ScrollIndex = p1460
				p1459:Update()
			end,
			["SetScrollPercent"] = function(p1461, p1462)
				local v1463 = (p1461.TotalSpace - p1461.VisibleSpace) * p1462 + 0.5
				p1461.ScrollIndex = math.floor(v1463)
				p1461:Update()
			end,
		},
	}
	v_u_1464.__index.CanScrollRight = v_u_1464.__index.CanScrollDown
	v_u_1464.__index.CanScrollLeft = v_u_1464.__index.CanScrollUp
	v_u_1464.__index.ScrollLeft = v_u_1464.__index.ScrollUp
	v_u_1464.__index.ScrollRight = v_u_1464.__index.ScrollDown
	function ScrollBar(p1465)
		local v_u_1466 = Create(
			"Frame",
			{
				["Name"] = "ScrollFrame",
				["Position"] = p1465 and UDim2.new(0, 0, 1, -16) or UDim2.new(1, -16, 0, 0),
				["Size"] = p1465 and UDim2.new(1, 0, 0, 16) or UDim2.new(0, 16, 1, 0),
				["BackgroundTransparency"] = 1,
				Create(
					"ImageButton",
					{
						["Name"] = "ScrollDown",
						["Position"] = p1465 and UDim2.new(1, -16, 0, 0) or UDim2.new(0, 0, 1, -16),
						["Size"] = UDim2.new(0, 16, 0, 16),
						["BackgroundColor3"] = v_u_1390.Button,
						["BorderColor3"] = v_u_1390.Border,
					}
				),
				Create(
					"ImageButton",
				...
				Create(
					...
					{
						["Name"] = "ScrollBar",
						["Size"] = p1465 and UDim2.new(1, -32, 1, 0) or UDim2.new(1, 0, 1, -32),
						["Position"] = p1465 and UDim2.new(0, 16, 0, 0) or UDim2.new(0, 0, 0, 16),
						["AutoButtonColor"] = false,
						["BackgroundColor3"] = Color3.new(0.94902, 0.94902, 0.94902),
						["BorderColor3"] = v_u_1390.Border,
						Create(
		...
		local v1467 =
			Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = v_u_1390.Border })
		local v_u_1468 = v_u_1466.ScrollDown
		local v_u_1469 = ArrowGraphic(8, p1465 and "Right" or "Down", true, v1467)
		v_u_1469.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1469.Parent = v_u_1468
		local v_u_1470 = v_u_1466.ScrollUp
		local v_u_1471 = ArrowGraphic(8, p1465 and "Left" or "Up", true, v1467)
		v_u_1471.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1471.Parent = v_u_1470
		local v_u_1472 = v_u_1466.ScrollBar
		local v_u_1473 = v_u_1472.ScrollThumb
		local v1474 = GripGraphic(Vector2.new(6, 6), p1465 and "Vertical" or "Horizontal", 2, v1467)
		v1474.Position = UDim2.new(0.5, -3, 0.5, -3)
		v1474.Parent = v_u_1473
		local v_u_1475 = Create(
			"ImageButton",
			{
				["Name"] = "MouseDrag",
				["Position"] = UDim2.new(-0.25, 0, -0.25, 0),
		...
		local v_u_1476 = setmetatable(
			{ ["GUI"] = v_u_1466, ["ScrollIndex"] = 0, ["VisibleSpace"] = 0, ["TotalSpace"] = 0, ["PageIncrement"] = 1 },
			v_u_1464
		)
		local v_u_1479 = p1465
				and function()
					v_u_1473.Size = UDim2.new(v_u_1476.VisibleSpace / v_u_1476.TotalSpace, 0, 0, 16)
					if v_u_1473.AbsoluteSize.x < 16 then
						v_u_1473.Size = UDim2.new(0, 16, 0, 16)
					end
					local v1477 = v_u_1472.AbsoluteSize.x
					v_u_1473.Position =
						UDim2.new(v_u_1476:GetScrollPercent() * (v1477 - v_u_1473.AbsoluteSize.x) / v1477, 0, 0, 0)
				end
			or function()
				v_u_1473.Size = UDim2.new(0, 16, v_u_1476.VisibleSpace / v_u_1476.TotalSpace, 0)
				if v_u_1473.AbsoluteSize.y < 16 then
					v_u_1473.Size = UDim2.new(0, 16, 0, 16)
				end
				local v1478 = v_u_1472.AbsoluteSize.y
				v_u_1473.Position =
					UDim2.new(0, 0, v_u_1476:GetScrollPercent() * (v1478 - v_u_1473.AbsoluteSize.y) / v1478, 0)
			end
		local v_u_1480 = nil
		local v_u_1481 = nil
		local v_u_1482 = { ["BackgroundColor3"] = v_u_1390.Border, ["BackgroundTransparency"] = 0 }
		local v_u_1483 = { ["BackgroundColor3"] = v_u_1390.Border, ["BackgroundTransparency"] = 0.7 }
		local function v1495()
			local v1484 = v_u_1476.TotalSpace
			local v1485 = v_u_1476.VisibleSpace
			local v1486 = v_u_1476.ScrollIndex
			if v1485 <= v1484 then
				if 0 < v1486 then
					if v1484 < v1486 + v1485 then
						v_u_1476.ScrollIndex = v1484 - v1485
					end
				else
					v_u_1476.ScrollIndex = 0
				end
			else
				v_u_1476.ScrollIndex = 0
			end
			if not v_u_1476.UpdateCallback or v_u_1476.UpdateCallback(v_u_1476) ~= false then
				local v1487 = v_u_1476:CanScrollDown()
				local v1488 = v_u_1476:CanScrollUp()
				if v1487 ~= v_u_1480 then
					v_u_1480 = v1487
					v_u_1468.Active = v1487
					v_u_1468.AutoButtonColor = v1487
					local v1489 = v_u_1469:GetChildren()
					local v1490 = v1487 and v_u_1482
					if not v1490 then
						v1490 = v_u_1483
					end
					for v1491 = 1, #v1489 do
						Create(v1489[v1491], v1490)
					end
				end
				if v1488 ~= v_u_1481 then
					v_u_1481 = v1488
					v_u_1470.Active = v1488
					v_u_1470.AutoButtonColor = v1488
					local v1492 = v_u_1471:GetChildren()
					local v1493 = v1488 and v_u_1482
					if not v1493 then
						v1493 = v_u_1483
					end
					for v1494 = 1, #v1492 do
						Create(v1492[v1494], v1493)
					end
				end
				v_u_1473.Visible = v1487 or v1488
				v_u_1479()
			end
		end
		v_u_1476.Update = v1495
		SetZIndexOnChanged(v_u_1466)
		local v_u_1496 = 0
		v_u_1468.MouseButton1Down:connect(function()
			v_u_1496 = tick()
			local v1497 = v_u_1496
			local v_u_1498 = nil
			v_u_1498 = v_u_1475.MouseButton1Up:connect(function()
				v_u_1496 = tick()
				v_u_1475.Parent = nil
				ResetButtonColor(v_u_1468)
				v_u_1498:disconnect()
				drag = nil
			end)
			v_u_1475.Parent = GetScreen(v_u_1466)
			v_u_1476:ScrollDown()
			wait(0.2)
			while v_u_1496 == v1497 do
				v_u_1476:ScrollDown()
				if not v_u_1476:CanScrollDown() then
					break
				end
				wait()
			end
		end)
		v_u_1468.MouseButton1Up:connect(function()
			v_u_1496 = tick()
		end)
		v_u_1470.MouseButton1Down:connect(function()
			v_u_1496 = tick()
			local v1499 = v_u_1496
			local v_u_1500 = nil
			v_u_1500 = v_u_1475.MouseButton1Up:connect(function()
				v_u_1496 = tick()
				v_u_1475.Parent = nil
				ResetButtonColor(v_u_1470)
				v_u_1500:disconnect()
				drag = nil
			end)
			v_u_1475.Parent = GetScreen(v_u_1466)
			v_u_1476:ScrollUp()
			wait(0.2)
			while v_u_1496 == v1499 do
				v_u_1476:ScrollUp()
				if not v_u_1476:CanScrollUp() then
					break
				end
				wait()
			end
		end)
		v_u_1470.MouseButton1Up:connect(function()
			v_u_1496 = tick()
		end)
		if p1465 then
			v_u_1472.MouseButton1Down:connect(function(p1501, _)
				v_u_1496 = tick()
				local v1502 = v_u_1496
				local v_u_1503 = nil
				v_u_1503 = v_u_1475.MouseButton1Up:connect(function()
					v_u_1496 = tick()
					v_u_1475.Parent = nil
					ResetButtonColor(v_u_1470)
					v_u_1503:disconnect()
				...
				v_u_1475.Parent = GetScreen(v_u_1466)
				if v_u_1473.AbsolutePosition.x < p1501 then
					v_u_1476:ScrollTo(v_u_1476.ScrollIndex + v_u_1476.VisibleSpace)
					wait(0.2)
					while v_u_1496 == v1502 and p1501 >= v_u_1473.AbsolutePosition.x + v_u_1473.AbsoluteSize.x do
						v_u_1476:ScrollTo(v_u_1476.ScrollIndex + v_u_1476.VisibleSpace)
						wait()
					end
				else
					v_u_1476:ScrollTo(v_u_1476.ScrollIndex - v_u_1476.VisibleSpace)
					wait(0.2)
					while v_u_1496 == v1502 and v_u_1473.AbsolutePosition.x >= p1501 do
						v_u_1476:ScrollTo(v_u_1476.ScrollIndex - v_u_1476.VisibleSpace)
						wait()
					end
				end
			...
			v_u_1472.MouseButton1Down:connect(function(_, p1504)
				v_u_1496 = tick()
				local v1505 = v_u_1496
				local v_u_1506 = nil
				v_u_1506 = v_u_1475.MouseButton1Up:connect(function()
					v_u_1496 = tick()
					v_u_1475.Parent = nil
					ResetButtonColor(v_u_1470)
					v_u_1506:disconnect()
				...
				v_u_1475.Parent = GetScreen(v_u_1466)
				if v_u_1473.AbsolutePosition.y < p1504 then
					v_u_1476:ScrollTo(v_u_1476.ScrollIndex + v_u_1476.VisibleSpace)
					wait(0.2)
					while v_u_1496 == v1505 and p1504 >= v_u_1473.AbsolutePosition.y + v_u_1473.AbsoluteSize.y do
						v_u_1476:ScrollTo(v_u_1476.ScrollIndex + v_u_1476.VisibleSpace)
						wait()
					end
				else
					v_u_1476:ScrollTo(v_u_1476.ScrollIndex - v_u_1476.VisibleSpace)
					wait(0.2)
					while v_u_1496 == v1505 and v_u_1473.AbsolutePosition.y >= p1504 do
						v_u_1476:ScrollTo(v_u_1476.ScrollIndex - v_u_1476.VisibleSpace)
						wait()
					end
				end
		...
		if p1465 then
			v_u_1473.MouseButton1Down:connect(function(p1507, _)
				v_u_1496 = tick()
				local v_u_1508 = p1507 - v_u_1473.AbsolutePosition.x
				local v_u_1509 = nil
				local v_u_1515 = v_u_1475.MouseMoved:connect(function(p1510, _)
					local v1511 = v_u_1472.AbsolutePosition.x
					local v1512 = v_u_1472.AbsoluteSize.x - v_u_1473.AbsoluteSize.x
					local v1513 = v1511 + v1512
					local v1514 = p1510 - v_u_1508
					if v1514 < v1511 and v1511 then
						v1514 = v1511
					elseif v1513 < v1514 then
						if v1513 then
							v1514 = v1513
						end
					end
					v_u_1476:SetScrollPercent((v1514 - v1511) / v1512)
				end)
				v_u_1509 = v_u_1475.MouseButton1Up:connect(function()
					v_u_1496 = tick()
					v_u_1475.Parent = nil
					ResetButtonColor(v_u_1473)
					v_u_1515:disconnect()
					v_u_1515 = nil
					v_u_1509:disconnect()
					drag = nil
			...
			v_u_1473.MouseButton1Down:connect(function(_, p1516)
				v_u_1496 = tick()
				local v_u_1517 = p1516 - v_u_1473.AbsolutePosition.y
				local v_u_1518 = nil
				local v_u_1524 = v_u_1475.MouseMoved:connect(function(_, p1519)
					local v1520 = v_u_1472.AbsolutePosition.y
					local v1521 = v_u_1472.AbsoluteSize.y - v_u_1473.AbsoluteSize.y
					local v1522 = v1520 + v1521
					local v1523 = p1519 - v_u_1517
					if v1523 < v1520 and v1520 then
						v1523 = v1520
					elseif v1522 < v1523 then
						if v1522 then
							v1523 = v1522
						end
					end
					v_u_1476:SetScrollPercent((v1523 - v1520) / v1521)
				end)
				v_u_1518 = v_u_1475.MouseButton1Up:connect(function()
					v_u_1496 = tick()
					v_u_1475.Parent = nil
					ResetButtonColor(v_u_1473)
					v_u_1524:disconnect()
		...
		function v_u_1476.Destroy(_)
			v_u_1466:Destroy()
			v_u_1475:Destroy()
			for v1525 in pairs(v_u_1476) do
				v_u_1476[v1525] = nil
			end
			setmetatable(v_u_1476, nil)
		end
		v1495()
		return v_u_1476
	end
	local v_u_1526 = ScrollBar(false)
	v_u_1526.PageIncrement = 16
	Create(
		v_u_1526.GUI,
		{ ["Position"] = UDim2.new(1, 0, 0, 0), ["Size"] = UDim2.new(0, 16, 1, 0), ["Parent"] = v_u_1377 }
	)
	local v_u_1527 = ScrollBar(true)
	v_u_1527.PageIncrement = 8
	Create(
		v_u_1527.GUI,
		{ ["Position"] = UDim2.new(0, 0, 1, 0), ["Size"] = UDim2.new(1, 0, 0, 16), ["Parent"] = v_u_1377 }
	)
	local v_u_1528 = {}
	local v_u_1529 = {}
	local v1530 = 1
	local v1531 = 1
	local v_u_1532 = 0
	for v1533 = 0, 490, 8 do
		local v1534 = {}
		for v1535 = 0, 390, 16 do
			local v1536 = Instance.new("TextLabel", v_u_1377)
			v1536.BackgroundTransparency = 1
			v1536.BorderSizePixel = 0
			v1536.Text = ""
			v1536.Position = UDim2.new(0, v1533, 0, v1535)
			v1536.Size = UDim2.new(0, 8, 0, 16)
			v1536.Font = Enum.Font.SourceSans
			v1536.FontSize = Enum.FontSize.Size18
			table.insert(v1534, v1536)
			v1531 = v1531 + 1
		end
		table.insert(v_u_1529, v1534)
		v1530 = v1530 + 1
		v1531 = 1
	end
	local v_u_1537 = {
		{ ["Keyword"] = "for", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "local", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "if", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "then", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "do", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "while", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "end", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "function", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "string", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "table", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "game", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "workspace", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "return", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "break", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "elseif", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "in", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "pairs", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
		{ ["Keyword"] = "ipairs", ["Color"] = Color3.new(0, 0, 0.4980392156862745), ["Independent"] = true },
	}
	function checkMouseInGui(p1538)
		if p1538 == nil then
			return false
		end
		local v1539 = game.Players.LocalPlayer:GetMouse()
		local v1540 = p1538.AbsolutePosition
		local v1541 = p1538.AbsoluteSize
		return v1539.X >= v1540.x
			and v1539.X <= v1540.x + v1541.x
			and v1539.Y >= v1540.y
			and v1539.Y <= v1540.y + v1541.y
	end
	function AddZeros(p1542, p1543)
		local v1544 = tostring(p1542)
		while #v1544 < p1543 do
			v1544 = " " .. v1544
		end
		return v1544
	end
	function buildScript(p1545, p1546, p1547, p1548)
		local v1549 = true
		if v_u_1378 ~= p1545 then
			v_u_1378 = p1545
		end
		if p1548 then
			v_u_1378 = p1545
			v_u_1528 = {}
			while v1549 do
				local v1550, v1551 = string.find(p1545, "\n")
				if v1550 and v1551 then
					local v1552 = string.sub
					table.insert(v_u_1528, v1552(p1545, 1, v1551))
					local v1553 = v1551 + 1
					local v1554 = string.len
					p1545 = string.sub(p1545, v1553, v1554(p1545))
				else
					table.insert(v_u_1528, p1545)
					v1549 = false
				end
			end
		end
		local v1555 = #v_u_1528
		v_u_1532 = #tostring(v1555)
		if v_u_1532 == 1 then
			v_u_1532 = 2
		end
		local v1556 = 1
		local v1557 = 2 + v_u_1532
		local v1558 = 0
		local v1559 = nil
		local v1560 = false
		local v1561 = v_u_1528
		for v1562 = 1, #v_u_1529 do
			for v1563 = 1, #v_u_1529[v1562] do
				if v1562 <= v_u_1532 then
					local v1564 = AddZeros(p1547 + v1563, v_u_1532)
					local v1565 = string.sub(v1564, v1562, v1562)
					if v1565 == " " then
						v_u_1529[v1562][v1563].Text = ""
					else
						v_u_1529[v1562][v1563].Text = v1565
					end
					v_u_1529[v1562][v1563].BackgroundTransparency = 0
					v_u_1529[v1562][v1563].BackgroundColor3 =
						Color3.new(0.6392156862745098, 0.6352941176470588, 0.6470588235294118)
				elseif v1562 == v_u_1532 + 1 then
					v_u_1529[v1562][v1563].Text = ""
					v_u_1529[v1562][v1563].BackgroundTransparency = 0
					v_u_1529[v1562][v1563].BackgroundColor3 =
						Color3.new(0.7843137254901961, 0.7843137254901961, 0.7843137254901961)
				else
					v_u_1529[v1562][v1563].Text = ""
					v_u_1529[v1562][v1563].BackgroundTransparency = 1
				end
			end
		end
		local v1566 = p1546
		while true do
			if #v1561 < v1556 or #v_u_1529[1] < v1556 then
				return
			end
			local v1567 = v1561[v1556 + p1547]
			while 0 < string.len(v1567) do
				if string.sub(v1567, 1, 1) == "\t" then
					v1567 = "    " .. string.sub(v1567, 2)
				end
				if #v_u_1529 < v1557 then
					break
				end
				if v1566 == 0 then
					v_u_1529[v1557][v1556].Text = string.sub(v1567, 1, 1)
				end
				if not v1560 then
					for _, v1568 in pairs(v_u_1537) do
						local v1569 = v1568.Keyword
						local v1570 = string.len
						if string.sub(v1567, 1, v1570(v1569)) == v1568.Keyword then
							if v1568.Independent then
								local v1571 = v1568.Keyword
								local v1572 = string.len(v1571) + 1
								local v1573 = string.sub(v1567, v1572, v1572)
								if not string.find(v1573, "%w") then
									local v1574 = v1568.Keyword
									v1558 = string.len(v1574)
									v1559 = v1568.Color
								end
							else
								local v1575 = v1568.Keyword
								v1558 = string.len(v1575)
								v1559 = v1568.Color
							end
						end
					end
				...
				if string.sub(v1567, 1, 1) == '"' then
					if string.match(v1567, '".+"') then
						local v1576 = string.match
						v1558 = string.len(v1576(v1567, '".+"'))
						v1559 = Color3.new(0.6666666666666666, 0, 1)
						v1560 = true
					end
				end
				if 0 < v1558 then
					v1558 = v1558 - 1
					v_u_1529[v1557][v1556].TextColor3 = v1559
					if v1558 == 0 then
						v1560 = false
					end
				else
					v_u_1529[v1557][v1556].TextColor3 = Color3.new(0, 0, 0)
					v1560 = false
				end
				if v1566 == 0 then
					v1557 = v1557 + 1
				...
				local v1577 = string.len
				v1567 = string.sub(v1567, 2, v1577(v1567))
			end
			v1556 = v1556 + 1
			v1557 = 2 + v_u_1532
			v1558 = 0
	...
	function v_u_1526.UpdateCallback(_)
		v_u_1526.TotalSpace = #v_u_1528 * 16
		v_u_1526.VisibleSpace = v_u_1377.AbsoluteSize.Y
		local v1578 = buildScript
		local v1579 = v_u_1527.ScrollIndex / 8
		local v1580 = math.floor(v1579)
		local v1581 = v_u_1526.ScrollIndex / 16
		v1578(v_u_1378, v1580, math.floor(v1581))
	end
	function v_u_1527.UpdateCallback(_)
		v_u_1527.TotalSpace = (getLongestEntry(v_u_1528) + 1 + v_u_1532) * 8
		v_u_1527.VisibleSpace = v_u_1377.AbsoluteSize.X
		local v1582 = buildScript
		local v1583 = v_u_1527.ScrollIndex / 8
		local v1584 = math.floor(v1583)
		local v1585 = v_u_1526.ScrollIndex / 16
		v1582(v_u_1378, v1584, math.floor(v1585))
	end
	function getLongestEntry(p1586)
		local v1587 = 0
		for _, v1588 in pairs(p1586) do
			if v1587 < string.len(v1588) then
				v1587 = string.len(v1588)
			end
		end
		return v1587
	end
	function openScript(p1589)
		if p1589:IsA("LocalScript") then
			p1589.Archivable = true
			p1589 = p1589:Clone()
			p1589.Disabled = true
		end
		local v1590 = p1589.Name
		local v1591 = decompile(p1589)
		table.insert(v_u_1388, { ["Name"] = v1590, ["Source"] = v1591 })
		local v_u_1592 = v_u_1385:Clone()
		v_u_1592.Button.Text = v1590
		v_u_1592.Position = UDim2.new(0, #v_u_1381:GetChildren() * 100, 0, 0)
		v_u_1592.Visible = true
		v_u_1592.Button.MouseButton1Down:connect(function()
			for v1593, v1594 in pairs(v_u_1381:GetChildren()) do
				if v1594 == v_u_1592 then
					v_u_1389 = v1593
					buildScript(v_u_1388[v1593].Source, 0, 0, true)
					v_u_1526:ScrollTo(1)
					v_u_1526:Update()
					v_u_1527:ScrollTo(1)
					v_u_1527:Update()
		...
		v_u_1592.Close.MouseButton1Click:connect(function()
			for v1595, v1596 in pairs(v_u_1381:GetChildren()) do
				if v1596 == v_u_1592 then
					table.remove(v_u_1388, v1595)
					if v_u_1389 == v1595 then
						v_u_1389 = #v_u_1388
						if 0 < v_u_1389 then
							buildScript(v_u_1388[#v_u_1388].Source, 0, 0, true)
						else
					...
					v_u_1527:ScrollTo(1)
					v_u_1527:Update()
					for v1597 = v1595, #v_u_1381:GetChildren() do
						v_u_1381:GetChildren()[v1597].Position = v_u_1381:GetChildren()[v1597].Position
							+ UDim2.new(0, -100, 0, 0)
					end
					if v1595 < v_u_1389 then
						v_u_1389 = v_u_1389 - 1
					end
					v_u_1592:Destroy()
				end
		...
		v_u_1389 = #v_u_1388
		buildScript(v1591, 0, 0, true)
		v_u_1592.Parent = v_u_1381
	end
	function updateScriptBar()
		local v1598 = 0
		v_u_1382.Active = false
		v_u_1382.AutoButtonColor = false
		for _, v1599 in pairs(v_u_1382["Arrow Graphic"]:GetChildren()) do
			v1599.BackgroundTransparency = 0.7
		end
		v_u_1383.Active = false
		v_u_1383.AutoButtonColor = false
		for _, v1600 in pairs(v_u_1383["Arrow Graphic"]:GetChildren()) do
			v1600.BackgroundTransparency = 0.7
		end
		for _, v1601 in pairs(v_u_1381:GetChildren()) do
			if v1601.Position.X.Offset < 0 then
				v_u_1382.Active = true
				v_u_1382.AutoButtonColor = true
				for _, v1602 in pairs(v_u_1382["Arrow Graphic"]:GetChildren()) do
					v1602.BackgroundTransparency = 0
				end
			elseif 0 <= v1601.Position.X.Offset then
				v1598 = v1598 + 1
				if v1598 == 5 then
					v_u_1383.Active = true
					v_u_1383.AutoButtonColor = true
					for _, v1603 in pairs(v_u_1383["Arrow Graphic"]:GetChildren()) do
						v1603.BackgroundTransparency = 0
					end
				end
			end
		end
	end
	v_u_1381.ChildAdded:connect(updateScriptBar)
	v_u_1381.ChildRemoved:connect(updateScriptBar)
	v_u_1382.MouseButton1Click:connect(function()
		if v_u_1382.Active ~= false then
			for _, v1604 in pairs(v_u_1381:GetChildren()) do
				v1604.Position = v1604.Position + UDim2.new(0, 100, 0, 0)
			end
			updateScriptBar()
		end
	end)
	v_u_1383.MouseButton1Click:connect(function()
		if v_u_1383.Active ~= false then
			for _, v1605 in pairs(v_u_1381:GetChildren()) do
				v1605.Position = v1605.Position + UDim2.new(0, -100, 0, 0)
			end
			updateScriptBar()
		end
	end)
	v1379.Button1Down:connect(function()
		checkMouseInGui(v_u_1377)
	end)
	v1386.Event:connect(function(...)
		v_u_1376.Visible = true
		local v1606 = { ... }
		if 0 < #v1606 then
			openScript(v1606[1])
		end
	end)
	v1384.MouseButton1Click:connect(function()
		if Clipboard and Clipboard.set then
			Clipboard.set(v_u_1378)
		elseif CopyString then
			CopyString(v_u_1378)
		end
	end)
	v1387.MouseButton1Click:connect(function()
		v_u_1376.Visible = false
	end)
	buildScript("", 0, 0, true)
	v_u_1526:Update()
	v_u_1527:Update()
